...
class HXCPP_CLASS_ATTRIBUTES CairoGraphics_obj : public hx::Object
{
	...
	public:
		...
		static void render( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::cairo::CairoRenderer renderer);
		static ::Dynamic render_dyn();

		static void renderMask( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::cairo::CairoRenderer renderer);
