...
class HXCPP_CLASS_ATTRIBUTES Context3DGraphics_obj : public hx::Object
{
	...
	public:
		...
		static void buildBuffer( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::context3D::Context3DRenderer renderer);
		static ::Dynamic buildBuffer_dyn();

		static bool isCompatible( ::openfl::display::Graphics graphics);
		static ::Dynamic isCompatible_dyn();

		static void render( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::context3D::Context3DRenderer renderer);
		static ::Dynamic render_dyn();

		static void renderMask( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::context3D::Context3DRenderer renderer);
