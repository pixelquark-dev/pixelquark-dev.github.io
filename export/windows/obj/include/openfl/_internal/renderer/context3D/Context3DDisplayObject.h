...
class HXCPP_CLASS_ATTRIBUTES Context3DDisplayObject_obj : public hx::Object
{
	...
	public:
		...
		static void render( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::context3D::Context3DRenderer renderer);
		static ::Dynamic render_dyn();

		static void renderMask( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::context3D::Context3DRenderer renderer);
