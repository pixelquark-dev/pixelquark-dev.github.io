...
#define INCLUDED_openfl__internal_formats_animate_AnimateShapeSymbol
...
class HXCPP_CLASS_ATTRIBUTES AnimateShapeSymbol_obj : public  ::openfl::_internal::formats::animate::AnimateSymbol_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x74f8a551 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="openfl._internal.formats.animate.AnimateShapeSymbol")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.formats.animate.AnimateShapeSymbol"); }
...
#endif /* INCLUDED_openfl__internal_formats_animate_AnimateShapeSymbol */ 
