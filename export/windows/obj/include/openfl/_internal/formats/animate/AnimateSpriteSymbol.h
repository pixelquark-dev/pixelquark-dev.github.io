...
#define INCLUDED_openfl__internal_formats_animate_AnimateSpriteSymbol
...
class HXCPP_CLASS_ATTRIBUTES AnimateSpriteSymbol_obj : public  ::openfl::_internal::formats::animate::AnimateSymbol_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x4b09ac51 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="openfl._internal.formats.animate.AnimateSpriteSymbol")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.formats.animate.AnimateSpriteSymbol"); }
		...
		void _hx___constructor( ::openfl::display::MovieClip movieClip);
...
#endif /* INCLUDED_openfl__internal_formats_animate_AnimateSpriteSymbol */ 
