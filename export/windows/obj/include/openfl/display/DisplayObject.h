...
class HXCPP_CLASS_ATTRIBUTES DisplayObject_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		bool _hx___cacheAsBitmap;
		 ...
		 ::openfl::display::BitmapData _hx___cacheBitmapDataTexture;
		 ::openfl::geom::Matrix _hx___cacheBitmapMatrix;
		 ::openfl::display::DisplayObjectRenderer _hx___cacheBitmapRendererHW;
		 ::openfl::display::DisplayObjectRenderer _hx___cacheBitmapRendererSW;
