...
class HXCPP_CLASS_ATTRIBUTES BitmapData_obj : public hx::Object
{
	...
	public:
		...
		static  ::openfl::_internal::renderer::context3D::Context3DRenderer _hx___hardwareRenderer;
		static  ::openfl::_internal::renderer::BitmapDataPool _hx___pool;
		static  ::openfl::display::DisplayObjectRenderer _hx___softwareRenderer;
		...
		int _hx___textureWidth;
		 ...
		 ::openfl::_internal::renderer::DisplayObjectType _hx___type;
		...
		void _hx___setVertex(int index,Float x,Float y,Float u,Float v);
		::Dynamic _hx___setVertex_dyn();

		void _hx___setVertices(::Array< int > indices,Float x,Float y,Float u,Float v);
		::Dynamic _hx___setVertices_dyn();

		void _hx___setUOffsets(::Array< int > indices,Float offset);
		::Dynamic _hx___setUOffsets_dyn();

		void _hx___setVOffsets(::Array< int > indices,Float offset);
		::Dynamic _hx___setVOffsets_dyn();
