...
HX_DECLARE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_917_new)
...
HXLINE( 918)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers = GroupMembers;
HXLINE( 919)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_filter = filter;
HXLINE( 920)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_cursor = 0;
HXLINE( 921)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_length = ( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers->get_length();
            	}
