...
HXDLIN(  24)			return this->gamepad->checkStatusRaw(stick->x,this->status);
            		}
HXDLIN(  24)		return false;
            	}
...
HXDLIN(  29)			return this->gamepad->checkStatusRaw(stick->y,this->status);
            		}
HXDLIN(  29)		return false;
            	}
...
HXDLIN(  39)			return this->gamepad->checkStatusRaw(stick->x,this->status);
            		}
HXDLIN(  39)		return false;
            	}
...
HXDLIN(  44)			return this->gamepad->checkStatusRaw(stick->y,this->status);
            		}
HXDLIN(  44)		return false;
            	}
...
HXLINE(  68)		bool xVal = this->gamepad->checkStatusRaw(stick->x,this->status);
HXLINE(  69)		bool yVal = this->gamepad->checkStatusRaw(stick->y,this->status);
...
HXLINE(  76)		if (xVal) {
HXLINE(  78)			bool yReleased = this->gamepad->checkStatusRaw(stick->y,0);
HXLINE(  79)			bool yJustReleased = this->gamepad->checkStatusRaw(stick->y,-1);
...
HXLINE(  86)		if (yVal) {
HXLINE(  88)			bool xReleased = this->gamepad->checkStatusRaw(stick->x,0);
HXLINE(  89)			bool xJustReleased = this->gamepad->checkStatusRaw(stick->x,-1);
...
HXLINE( 104)		return this->gamepad->checkStatusRaw(stick->x,this->status);
            	}
...
HXLINE( 112)		return this->gamepad->checkStatusRaw(stick->y,this->status);
            	}
...
HXDLIN( 122)		return this->gamepad->checkStatusRaw(RawID,Status);
            	}
