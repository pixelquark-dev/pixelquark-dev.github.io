...
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_421_removeGamepad,"flixel.input.gamepad.FlxGamepadManager","removeGamepad",0xfe38fe4a,"flixel.input.gamepad.FlxGamepadManager.removeGamepad","flixel/input/gamepad/FlxGamepadManager.hx",421,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_567_update,"flixel.input.gamepad.FlxGamepadManager","update",0x32fe94dc,"flixel.input.gamepad.FlxGamepadManager.update","flixel/input/gamepad/FlxGamepadManager.hx",567,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_572_onFocus,"flixel.input.gamepad.FlxGamepadManager","onFocus",0x68bae806,"flixel.input.gamepad.FlxGamepadManager.onFocus","flixel/input/gamepad/FlxGamepadManager.hx",572,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_576_onFocusLost,"flixel.input.gamepad.FlxGamepadManager","onFocusLost",0xeb47390a,"flixel.input.gamepad.FlxGamepadManager.onFocusLost","flixel/input/gamepad/FlxGamepadManager.hx",576,0xccfee0a6)
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_580_get_numActiveGamepads,"flixel.input.gamepad.FlxGamepadManager","get_numActiveGamepads",0x4cfd1ae2,"flixel.input.gamepad.FlxGamepadManager.get_numActiveGamepads","flixel/input/gamepad/FlxGamepadManager.hx",580,0xccfee0a6)
...
HXLINE( 246)					switch((int)(buttonID)){
            						case (int)-2: {
HXLINE( 246)							switch((int)(state)){
            								case (int)-1: {
HXLINE( 246)									_hx_tmp = gamepad->justReleased->get_ANY();
            								}
            								break;
            								case (int)0: {
HXLINE( 246)									_hx_tmp = gamepad->released->get_ANY();
            								}
            								break;
            								case (int)1: {
HXLINE( 246)									_hx_tmp = gamepad->pressed->get_ANY();
            								}
            								break;
            								case (int)2: {
HXLINE( 246)									_hx_tmp = gamepad->justPressed->get_ANY();
            								}
            								break;
            							}
            						}
...
HXLINE( 246)							switch((int)(state)){
            								case (int)-1: {
HXLINE( 246)									_hx_tmp = gamepad->justReleased->get_NONE();
            								}
            								break;
            								case (int)0: {
HXLINE( 246)									_hx_tmp = gamepad->released->get_NONE();
            								}
            								break;
            								case (int)1: {
HXLINE( 246)									_hx_tmp = gamepad->pressed->get_NONE();
            								}
            								break;
            								case (int)2: {
HXLINE( 246)									_hx_tmp = gamepad->justPressed->get_NONE();
            								}
            								break;
            							}
            						}
...
HXDLIN( 246)							if (hx::IsNull( button )) {
HXLINE( 246)								_hx_tmp = false;
            							}
            							else {
HXLINE( 246)								int value = button->current;
HXDLIN( 246)								switch((int)(state)){
            									case (int)-1: {
HXLINE( 246)										_hx_tmp = (value == -1);
            									}
            									break;
            									case (int)0: {
HXLINE( 246)										_hx_tmp = (value == 0);
            									}
            									break;
            									case (int)1: {
HXLINE( 246)										_hx_tmp = (value == 1);
...
HXLINE( 406)						_hx_tmp1 = (name.indexOf(HX_("360",2d,e2,26,00),null()) != -1);
            					}
            					else {
HXLINE( 406)						_hx_tmp1 = false;
            					}
HXDLIN( 406)					if (_hx_tmp1) {
HXLINE( 406)						return ::flixel::input::gamepad::FlxGamepadModel_obj::XINPUT_dyn();
            					}
            					else {
HXLINE( 406)						if ((name.indexOf(HX_("xinput",92,10,f1,b8),null()) != -1)) {
HXLINE( 407)							return ::flixel::input::gamepad::FlxGamepadModel_obj::XINPUT_dyn();
            						}
            						else {
HXLINE( 408)							if ((name.indexOf(HX_("nintendo rvlcnt01tr",cb,02,13,80),null()) != -1)) {
HXLINE( 409)								return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            							}
            							else {
HXLINE( 410)								if ((name.indexOf(HX_("nintendo rvlcnt01",0d,c0,58,28),null()) != -1)) {
HXLINE( 411)									return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            								}
            								else {
HXLINE( 412)									if ((name.indexOf(HX_("mayflash wiimote pc adapter",ed,5a,02,8e),null()) != -1)) {
HXLINE( 413)										return ::flixel::input::gamepad::FlxGamepadModel_obj::MAYFLASH_WII_REMOTE_dyn();
            									}
            									else {
HXLINE( 414)										if ((name.indexOf(HX_("mfi",f0,0e,53,00),null()) != -1)) {
HXLINE( 415)											return ::flixel::input::gamepad::FlxGamepadModel_obj::MFI_dyn();
            										}
            										else {
HXLINE( 417)											return ::flixel::input::gamepad::FlxGamepadModel_obj::UNKNOWN_dyn();
            										}
            									}
            								}
            							}
...
void FlxGamepadManager_obj::removeGamepad( ::openfl::ui::GameInputDevice Device){
            	HX_STACKFRAME(&_hx_pos_dd40c6c1396c027e_421_removeGamepad)
HXLINE( 422)		if (hx::IsNull( Device )) {
HXLINE( 423)			return;
            		}
HXLINE( 425)		{
HXLINE( 425)			int _g = 0;
HXDLIN( 425)			int _g1 = this->_gamepads->length;
HXDLIN( 425)			while((_g < _g1)){
HXLINE( 425)				_g = (_g + 1);
HXDLIN( 425)				int i = (_g - 1);
HXLINE( 427)				 ::flixel::input::gamepad::FlxGamepad gamepad = this->_gamepads->__get(i).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXLINE( 428)				bool _hx_tmp;
HXDLIN( 428)				if (hx::IsNotNull( gamepad )) {
HXLINE( 428)					_hx_tmp = hx::IsEq( gamepad->_device,Device );
            				}
            				else {
HXLINE( 428)					_hx_tmp = false;
            				}
HXDLIN( 428)				if (_hx_tmp) {
HXLINE( 430)					this->removeByID(i);
            				}
            			}
            		}
            	}
...
void FlxGamepadManager_obj::update(){
            	HX_STACKFRAME(&_hx_pos_dd40c6c1396c027e_567_update)
HXDLIN( 567)		int _g = 0;
HXDLIN( 567)		::Array< ::Dynamic> _g1 = this->_gamepads;
HXDLIN( 567)		while((_g < _g1->length)){
HXDLIN( 567)			 ::flixel::input::gamepad::FlxGamepad gamepad = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 567)			_g = (_g + 1);
HXLINE( 568)			if (hx::IsNotNull( gamepad )) {
HXLINE( 569)				gamepad->update();
            			}
            		}
            	}
...
void FlxGamepadManager_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_dd40c6c1396c027e_572_onFocus)
            	}
...
void FlxGamepadManager_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_dd40c6c1396c027e_576_onFocusLost)
HXDLIN( 576)		this->reset();
            	}
...
int FlxGamepadManager_obj::get_numActiveGamepads(){
            	HX_STACKFRAME(&_hx_pos_dd40c6c1396c027e_580_get_numActiveGamepads)
HXLINE( 581)		int count = 0;
HXLINE( 582)		{
HXLINE( 582)			int _g = 0;
HXDLIN( 582)			::Array< ::Dynamic> _g1 = this->_gamepads;
HXDLIN( 582)			while((_g < _g1->length)){
HXLINE( 582)				 ::flixel::input::gamepad::FlxGamepad gamepad = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 582)				_g = (_g + 1);
HXLINE( 583)				if (hx::IsNotNull( gamepad )) {
HXLINE( 584)					count = (count + 1);
            				}
            			}
            		}
HXLINE( 585)		return count;
            	}
