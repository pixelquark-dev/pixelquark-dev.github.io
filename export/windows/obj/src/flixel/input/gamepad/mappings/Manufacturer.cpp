...
#endif
HX_LOCAL_STACK_FRAME(_hx_pos_b569b380ca8d168f_107_boot,"Manufacturer_obj","boot",0x8a661ed7,"Manufacturer_obj.boot","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",107,0x5edd1803)
namespace flixel{
namespace input{
namespace gamepad{
namespace mappings{
...
{
{
            	HX_STACKFRAME(&_hx_pos_b569b380ca8d168f_107_boot)
HXDLIN( 107)		__mClass->__meta__ =  ::Dynamic(hx::Anon_obj::Create(1)
