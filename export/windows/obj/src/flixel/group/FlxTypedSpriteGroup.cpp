...
HXLINE( 635)					int _g2 = 0;
HXDLIN( 635)					int _g11 = numProps;
HXDLIN( 635)					while((_g2 < _g11)){
HXLINE( 635)						_g2 = (_g2 + 1);
HXDLIN( 635)						int i = (_g2 - 1);
...
HXLINE( 727)				_hx_tmp1 = (this->alpha != 0);
            			}
            			else {
...
HXDLIN(1001)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
...
HXDLIN(1024)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
...
HXDLIN(1036)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
