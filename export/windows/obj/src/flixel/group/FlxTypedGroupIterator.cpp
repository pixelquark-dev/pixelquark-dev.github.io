...
HX_DEFINE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_917_new,"flixel.group.FlxTypedGroupIterator","new",0xa7153fe6,"flixel.group.FlxTypedGroupIterator.new","flixel/group/FlxGroup.hx",917,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_926_next,"flixel.group.FlxTypedGroupIterator","next",0x8b82aaad,"flixel.group.FlxTypedGroupIterator.next","flixel/group/FlxGroup.hx",926,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_930_hasNext,"flixel.group.FlxTypedGroupIterator","hasNext",0x559d4ff3,"flixel.group.FlxTypedGroupIterator.hasNext","flixel/group/FlxGroup.hx",930,0x1e89d58e)
namespace flixel{
namespace group{

void FlxTypedGroupIterator_obj::__construct(::cpp::VirtualArray GroupMembers, ::Dynamic filter){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_917_new)
HXLINE( 918)		this->_groupMembers = GroupMembers;
HXLINE( 919)		this->_filter = filter;
HXLINE( 920)		this->_cursor = 0;
HXLINE( 921)		this->_length = this->_groupMembers->get_length();
            	}
...
bool FlxTypedGroupIterator_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FlxTypedGroupIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_926_next)
HXDLIN( 926)		if (this->hasNext()) {
HXDLIN( 926)			return this->_groupMembers->__get(this->_cursor++);
            		}
            		else {
...
bool FlxTypedGroupIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_930_hasNext)
HXLINE( 931)		while(true){
HXLINE( 931)			bool _hx_tmp;
HXDLIN( 931)			if ((this->_cursor < this->_length)) {
HXLINE( 931)				if (hx::IsNotNull( this->_groupMembers->__get(this->_cursor) )) {
HXLINE( 931)					if (hx::IsNotNull( this->_filter )) {
HXLINE( 931)						_hx_tmp = !(( (bool)(this->_filter(this->_groupMembers->__get(this->_cursor))) ));
            					}
            					else {
...
HXLINE( 931)				goto _hx_goto_2;
            			}
HXLINE( 933)			this->_cursor++;
            		}
            		_hx_goto_2:;
HXLINE( 935)		return (this->_cursor < this->_length);
            	}
