...
HXDLIN( 863)				_hx_tmp1 = (object2 < (X + this->get_width()));
            			}
            			else {
...
HXDLIN( 863)				_hx_tmp = ((object3 + object->get_height()) > Y);
            			}
            			else {
...
HXDLIN( 872)		bool _hx_tmp3;
HXDLIN( 872)		Float objectScreenPos1 = objectScreenPos->x;
HXDLIN( 872)		Float _hx_tmp4 = (objectScreenPos1 + object->get_width());
HXDLIN( 872)		if ((_hx_tmp4 > this->_point->x)) {
HXLINE( 873)			Float objectScreenPos2 = objectScreenPos->x;
HXDLIN( 873)			Float _hx_tmp5 = this->_point->x;
HXLINE( 872)			_hx_tmp3 = (objectScreenPos2 < (_hx_tmp5 + this->get_width()));
            		}
            		else {
...
HXDLIN( 874)			Float _hx_tmp6 = (objectScreenPos3 + object->get_height());
HXLINE( 872)			_hx_tmp2 = (_hx_tmp6 > this->_point->y);
            		}
            		else {
HXLINE( 872)			_hx_tmp2 = false;
            		}
HXDLIN( 872)		if (_hx_tmp2) {
HXLINE( 875)			Float objectScreenPos4 = objectScreenPos->y;
HXDLIN( 875)			Float _hx_tmp7 = this->_point->y;
HXDLIN( 875)			return (objectScreenPos4 < (_hx_tmp7 + this->get_height()));
            		}
            		else {
...
HXLINE(1068)			Float _hx_tmp1 = (( (Float)(::flixel::FlxG_obj::height) ) / ( (Float)(2) ));
HXDLIN(1068)			this->set_y((_hx_tmp1 - (this->get_height() / ( (Float)(2) ))));
            		}
...
HXDLIN(1181)			_this1->x = ( (Float)(::Math_obj::floor(_this1->x)) );
HXDLIN(1181)			_this1->y = ( (Float)(::Math_obj::floor(_this1->y)) );
HXDLIN(1181)			_this1->width = ( (Float)(::Math_obj::floor(_this1->width)) );
HXDLIN(1181)			_this1->height = ( (Float)(::Math_obj::floor(_this1->height)) );
            		}
...
HXLINE( 149)						_hx_tmp4 = ((Object1->allowCollisions & 16) == 0);
            					}
            					else {
HXLINE( 149)						_hx_tmp4 = true;
            					}
HXDLIN( 149)					if (!(_hx_tmp4)) {
HXLINE( 149)						_hx_tmp3 = ((Object2->allowCollisions & 1) == 0);
            					}
            					else {
...
HXDLIN( 157)						Object12->touching = (Object12->touching | 16);
...
HXLINE( 164)							_hx_tmp7 = ((Object1->allowCollisions & 1) == 0);
            						}
            						else {
HXLINE( 164)							_hx_tmp7 = true;
            						}
HXDLIN( 164)						if (!(_hx_tmp7)) {
HXLINE( 164)							_hx_tmp6 = ((Object2->allowCollisions & 16) == 0);
            						}
            						else {
...
HXDLIN( 172)							Object14->touching = (Object14->touching | 1);
HXLINE( 173)							 ::flixel::FlxObject Object22 = Object2;
HXDLIN( 173)							Object22->touching = (Object22->touching | 16);
            						}
            					}
            				}
            			}
...
HXLINE( 306)						_hx_tmp4 = ((Object1->allowCollisions & 4096) == 0);
            					}
            					else {
HXLINE( 306)						_hx_tmp4 = true;
            					}
HXDLIN( 306)					if (!(_hx_tmp4)) {
HXLINE( 306)						_hx_tmp3 = ((Object2->allowCollisions & 256) == 0);
            					}
            					else {
...
HXDLIN( 314)						Object12->touching = (Object12->touching | 4096);
...
HXLINE( 321)							_hx_tmp7 = ((Object1->allowCollisions & 256) == 0);
            						}
            						else {
HXLINE( 321)							_hx_tmp7 = true;
            						}
HXDLIN( 321)						if (!(_hx_tmp7)) {
HXLINE( 321)							_hx_tmp6 = ((Object2->allowCollisions & 4096) == 0);
            						}
            						else {
...
HXDLIN( 329)							Object14->touching = (Object14->touching | 256);
HXLINE( 330)							 ::flixel::FlxObject Object22 = Object2;
HXDLIN( 330)							Object22->touching = (Object22->touching | 4096);
            						}
            					}
            				}
            			}
...
HXDLIN( 397)						_g1->set_x((_g1->x + (Object2->x - Object2->last->x)));
            					}
            				}
            				else {
HXLINE( 400)					if (!(obj2immovable)) {
HXLINE( 402)						{
HXLINE( 402)							 ::flixel::FlxObject _g2 = Object2;
HXDLIN( 402)							_g2->set_y((_g2->y + overlap));
            						}
...
HXLINE( 407)							 ::flixel::FlxObject _g3 = Object2;
HXDLIN( 407)							_g3->set_x((_g3->x + (Object1->x - Object1->last->x)));
            						}
            					}
            				}
            			}
