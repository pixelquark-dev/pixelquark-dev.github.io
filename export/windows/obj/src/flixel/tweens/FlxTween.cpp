...
HXLINE( 450)			Float _hx_tmp2;
HXDLIN( 450)			if (this->backward) {
HXLINE( 450)				_hx_tmp2 = ( (Float)(0) );
            			}
            			else {
HXLINE( 450)				_hx_tmp2 = ( (Float)(1) );
            			}
HXDLIN( 450)			this->scale = _hx_tmp2;
...
HXLINE( 541)				_hx_tmp4 = (this->scale > 0);
            			}
            			else {
HXLINE( 541)				_hx_tmp4 = false;
            			}
HXDLIN( 541)			if (_hx_tmp4) {
HXLINE( 541)				_hx_tmp3 = (this->scale < 1);
            			}
            			else {
