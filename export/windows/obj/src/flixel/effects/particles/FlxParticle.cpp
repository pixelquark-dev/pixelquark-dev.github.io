...
HXLINE( 175)				{
HXLINE( 175)					 ::flixel::math::FlxPoint _g2 = this->scale;
HXDLIN( 175)					_g2->set_x((_g2->x + ((( ( ::flixel::math::FlxPoint)(this->scaleRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->scaleRange->start) )->x) * this->_delta)));
            				}
HXLINE( 176)				{
HXLINE( 176)					 ::flixel::math::FlxPoint _g3 = this->scale;
HXDLIN( 176)					_g3->set_y((_g3->y + ((( ( ::flixel::math::FlxPoint)(this->scaleRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->scaleRange->start) )->y) * this->_delta)));
            				}
...
HXLINE( 183)				 ::flixel::effects::particles::FlxParticle _g4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 183)				_g4->set_alpha((_g4->alpha + ((( (Float)(this->alphaRange->end) ) - ( (Float)(this->alphaRange->start) )) * this->_delta)));
            			}
...
HXLINE( 193)				{
HXLINE( 193)					 ::flixel::math::FlxPoint _g5 = this->drag;
HXDLIN( 193)					_g5->set_x((_g5->x + ((( ( ::flixel::math::FlxPoint)(this->dragRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->dragRange->start) )->x) * this->_delta)));
            				}
HXLINE( 194)				{
HXLINE( 194)					 ::flixel::math::FlxPoint _g6 = this->drag;
HXDLIN( 194)					_g6->set_y((_g6->y + ((( ( ::flixel::math::FlxPoint)(this->dragRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->dragRange->start) )->y) * this->_delta)));
            				}
            			}
HXLINE( 197)			if (this->accelerationRange->active) {
HXLINE( 199)				{
HXLINE( 199)					 ::flixel::math::FlxPoint _g7 = this->acceleration;
HXDLIN( 199)					_g7->set_x((_g7->x + ((( ( ::flixel::math::FlxPoint)(this->accelerationRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->accelerationRange->start) )->x) * this->_delta)));
            				}
HXLINE( 200)				{
HXLINE( 200)					 ::flixel::math::FlxPoint _g8 = this->acceleration;
HXDLIN( 200)					_g8->set_y((_g8->y + ((( ( ::flixel::math::FlxPoint)(this->accelerationRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->accelerationRange->start) )->y) * this->_delta)));
            				}
            			}
