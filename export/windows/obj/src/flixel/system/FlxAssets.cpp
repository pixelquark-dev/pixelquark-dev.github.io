...
HXLINE( 233)		 ::flixel::graphics::FlxGraphic graphic = ::flixel::graphics::FlxGraphic_obj::fromClass(hx::ClassOf< ::flixel::_hx_system::GraphicVirtualInput >(),null(),null(),null());
HXLINE( 234)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(graphic,::Std_obj::string( ::flixel::_hx_system::VirtualInputData_obj::__alloc( HX_CTX ,null())));
            	}
