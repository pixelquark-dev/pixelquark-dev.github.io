...
HXDLIN( 362)				bool _hx_tmp4;
HXDLIN( 362)				bool _hx_tmp5;
HXDLIN( 362)				if ((mouseX >= 0)) {
HXLINE( 362)					_hx_tmp5 = (mouseX <= this->_width);
            				}
            				else {
HXLINE( 362)					_hx_tmp5 = false;
            				}
HXDLIN( 362)				if (_hx_tmp5) {
HXLINE( 362)					_hx_tmp4 = (mouseY >= 0);
            				}
            				else {
HXLINE( 362)					_hx_tmp4 = false;
            				}
HXDLIN( 362)				if (_hx_tmp4) {
HXLINE( 362)					_hx_tmp3 = (mouseY <= this->_height);
            				}
            				else {
HXLINE( 362)					_hx_tmp3 = false;
            				}
HXDLIN( 362)				if (_hx_tmp3) {
HXLINE( 364)					bool _hx_tmp6;
HXDLIN( 364)					if ((mouseX <= this->_header->get_width())) {
HXLINE( 364)						_hx_tmp6 = (mouseY <= this->_header->get_height());
            					}
            					else {
HXLINE( 364)						_hx_tmp6 = false;
            					}
HXDLIN( 364)					this->_overHeader = _hx_tmp6;
HXLINE( 365)					if (this->_resizable) {
HXLINE( 367)						bool _hx_tmp7;
HXDLIN( 367)						int _hx_tmp8 = this->_width;
HXDLIN( 367)						if ((mouseX >= (( (Float)(_hx_tmp8) ) - this->_handle->get_width()))) {
HXLINE( 367)							int _hx_tmp9 = this->_height;
HXDLIN( 367)							_hx_tmp7 = (mouseY >= (( (Float)(_hx_tmp9) ) - this->_handle->get_height()));
            						}
            						else {
HXLINE( 367)							_hx_tmp7 = false;
            						}
HXDLIN( 367)						this->_overHandle = _hx_tmp7;
            					}
            				}
            				else {
...
HXLINE( 436)			 ::openfl::display::Bitmap _hx_tmp6 = this->_handle;
HXDLIN( 436)			int _hx_tmp7 = this->_width;
HXDLIN( 436)			_hx_tmp6->set_x((( (Float)(_hx_tmp7) ) - this->_handle->get_width()));
HXLINE( 437)			 ::openfl::display::Bitmap _hx_tmp8 = this->_handle;
HXDLIN( 437)			int _hx_tmp9 = this->_height;
HXDLIN( 437)			_hx_tmp8->set_y((( (Float)(_hx_tmp9) ) - this->_handle->get_height()));
            		}
HXLINE( 439)		if (hx::IsNotNull( this->_closeButton )) {
HXLINE( 441)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp10 = this->_closeButton;
HXDLIN( 441)			int _hx_tmp11 = this->_width;
HXDLIN( 441)			_hx_tmp10->set_x(((( (Float)(_hx_tmp11) ) - this->_closeButton->get_width()) - ( (Float)(3) )));
