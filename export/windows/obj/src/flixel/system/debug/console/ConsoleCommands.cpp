...
HXLINE(  98)				::String _hx_tmp1;
HXDLIN(  98)				if (this->_console->registeredFunctions->exists(Alias)) {
HXLINE(  98)					_hx_tmp1 = HX_("()",01,23,00,00);
            				}
            				else {
HXLINE(  98)					_hx_tmp1 = HX_("",00,00,00,00);
            				}
HXDLIN(  98)				return (((Alias + _hx_tmp1) + HX_(": ",a6,32,00,00)) + this->_console->registeredHelp->get(Alias));
            			}
            			else {
...
HXLINE( 134)			::String Text1 = ((HX_("create: New ",82,f9,21,bf) + ::Std_obj::string(ObjClass)) + HX_(" created at X = ",00,f4,df,3b));
HXDLIN( 134)			::String Text2 = ((((Text1 + obj->x) + HX_(" Y = ",ca,0a,bf,a7)) + obj->y) + HX_(" with params ",20,c2,85,fb));
HXDLIN( 134)			 ::Dynamic Text3 = (Text2 + ::Std_obj::string(Params));
HXDLIN( 134)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,Text3),::flixel::_hx_system::debug::log::LogStyle_obj::CONSOLE,null());
            		}
...
HXLINE( 141)		{
HXLINE( 141)			 ::Dynamic Text4 = ((((HX_("create: ",a2,50,f4,2b) + ::Std_obj::string(ObjClass)) + HX_(" registered as '",b7,f0,b7,dc)) + name) + HX_("'",27,00,00,00));
HXDLIN( 141)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,Text4),::flixel::_hx_system::debug::log::LogStyle_obj::CONSOLE,null());
            		}
            	}
...
HXLINE( 168)			{
HXLINE( 168)				 ::flixel::_hx_system::frontEnds::WatchFrontEnd _this1 = ::flixel::FlxG_obj::watch;
