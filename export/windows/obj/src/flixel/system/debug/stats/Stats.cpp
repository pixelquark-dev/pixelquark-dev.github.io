...
HXLINE( 271)			 ::flixel::_hx_system::debug::stats::StatsGraph _hx_tmp1 = this->memoryGraph;
HXDLIN( 271)			_hx_tmp1->update(((( (Float)(::openfl::_hx_system::System_obj::get_totalMemory()) ) / ( (Float)(1024) )) / ( (Float)(1000) )));
...
HXLINE( 280)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 280)					_hx_tmp2->updateTime = (_hx_tmp2->updateTime + this->_update->__get(i));
            				}
            			}
HXLINE( 283)			{
...
HXLINE( 285)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 285)					_hx_tmp3->activeCount = (_hx_tmp3->activeCount + this->_activeObject->__get(i1));
            				}
            			}
...
HXDLIN( 290)					int i2 = (_g4 - 1);
HXLINE( 292)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 292)					_hx_tmp4->drawTime = (_hx_tmp4->drawTime + this->_draw->__get(i2));
            				}
            			}
HXLINE( 295)			{
...
HXLINE( 297)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp5 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 297)					_hx_tmp5->visibleCount = (_hx_tmp5->visibleCount + this->_visibleObject->__get(i3));
            				}
            			}
...
HXLINE( 303)				{
HXLINE( 303)					int _g8 = 0;
HXDLIN( 303)					int _g9 = this->_drawCallsMarker;
HXDLIN( 303)					while((_g8 < _g9)){
HXLINE( 303)						_g8 = (_g8 + 1);
HXDLIN( 303)						int i4 = (_g8 - 1);
HXLINE( 305)						 ::flixel::_hx_system::debug::stats::Stats _hx_tmp6 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 305)						_hx_tmp6->drawCallsCount = (_hx_tmp6->drawCallsCount + this->_drawCalls->__get(i4));
            					}
            				}
...
HXLINE( 319)			 ::flixel::_hx_system::debug::stats::Stats _hx_tmp7 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 319)			_hx_tmp7->_updateTimer = (_hx_tmp7->_updateTimer - 250);
            		}
            	}
...
HXLINE( 455)			{
HXLINE( 455)				 ::flixel::_hx_system::debug::stats::Stats _g1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 455)				_g1->set_x((_g1->get_x() + 160));
            			}
HXLINE( 456)			this->drawTimeGraph->set_visible(false);
HXLINE( 457)			this->updateTimeGraph->set_visible(false);
HXLINE( 458)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp1 = this->_toggleSizeButton;
HXDLIN( 458)			_hx_tmp1->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()));
            		}
