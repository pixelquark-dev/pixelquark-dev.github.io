...
HXLINE(  45)			::String _g1 = data->_hx_getString(1);
HXDLIN(  45)			 ::Dynamic _g = data->_hx_getObject(0);
...
HXDLIN(  56)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE(  58)				::String _g5 = _g->_hx_getString(1);
HXDLIN(  58)				 ::Dynamic _g4 = _g->_hx_getObject(0);
...
HXDLIN(  59)				return 10875373;
            			...
            			break;
            			case (int)2: {
HXLINE(  60)				 ::hscript::Expr _g3 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE(  98)					::String _g1 = _g->_hx_getString(0);
            				...
            				break;
            				case (int)2: {
HXLINE(  96)					 ::hscript::Expr _g3 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN(  96)					{
...
HXLINE( 122)				return value;
            			...
            			break;
            			case (int)2: {
HXLINE( 115)				::String _g2 = _g->_hx_getString(0);
