...
HXLINE( 101)		if ((::flixel::_hx_system::debug::watch::Tracker_obj::objectsBeingTracked->indexOf(ObjectOrClass,null()) != -1)) {
...
HXLINE( 111)			 ::flixel::_hx_system::debug::FlxDebugger _this1 = ::flixel::FlxG_obj::game->debugger;
...
HXDLIN( 111)			_this1->_windows->push(window);
HXDLIN( 111)			_this1->addChild(window);
HXDLIN( 111)			if (hx::IsNotNull( _this1->_screenBounds )) {
HXLINE( 111)				_this1->updateBounds();
