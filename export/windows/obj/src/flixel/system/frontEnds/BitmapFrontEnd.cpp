...
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_210_getKeyForClass,"flixel.system.frontEnds.BitmapFrontEnd","getKeyForClass",0x26696fcb,"flixel.system.frontEnds.BitmapFrontEnd.getKeyForClass","flixel/system/frontEnds/BitmapFrontEnd.hx",210,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_222_generateKey,"flixel.system.frontEnds.BitmapFrontEnd","generateKey",0xe3b3c7f7,"flixel.system.frontEnds.BitmapFrontEnd.generateKey","flixel/system/frontEnds/BitmapFrontEnd.hx",222,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_240_getUniqueKey,"flixel.system.frontEnds.BitmapFrontEnd","getUniqueKey",0x2898506b,"flixel.system.frontEnds.BitmapFrontEnd.getUniqueKey","flixel/system/frontEnds/BitmapFrontEnd.hx",240,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_271_getKeyWithSpacesAndBorders,"flixel.system.frontEnds.BitmapFrontEnd","getKeyWithSpacesAndBorders",0x04327ebf,"flixel.system.frontEnds.BitmapFrontEnd.getKeyWithSpacesAndBorders","flixel/system/frontEnds/BitmapFrontEnd.hx",271,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_295_remove,"flixel.system.frontEnds.BitmapFrontEnd","remove",0x5bfef0d7,"flixel.system.frontEnds.BitmapFrontEnd.remove","flixel/system/frontEnds/BitmapFrontEnd.hx",295,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_308_removeByKey,"flixel.system.frontEnds.BitmapFrontEnd","removeByKey",0x593bffb1,"flixel.system.frontEnds.BitmapFrontEnd.removeByKey","flixel/system/frontEnds/BitmapFrontEnd.hx",308,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_320_removeIfNoUse,"flixel.system.frontEnds.BitmapFrontEnd","removeIfNoUse",0x6b036552,"flixel.system.frontEnds.BitmapFrontEnd.removeIfNoUse","flixel/system/frontEnds/BitmapFrontEnd.hx",320,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_329_clearCache,"flixel.system.frontEnds.BitmapFrontEnd","clearCache",0xad367388,"flixel.system.frontEnds.BitmapFrontEnd.clearCache","flixel/system/frontEnds/BitmapFrontEnd.hx",329,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_349_removeKey,"flixel.system.frontEnds.BitmapFrontEnd","removeKey",0xe84d3108,"flixel.system.frontEnds.BitmapFrontEnd.removeKey","flixel/system/frontEnds/BitmapFrontEnd.hx",349,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_360_reset,"flixel.system.frontEnds.BitmapFrontEnd","reset",0xd15ce89c,"flixel.system.frontEnds.BitmapFrontEnd.reset","flixel/system/frontEnds/BitmapFrontEnd.hx",360,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_383_clearUnused,"flixel.system.frontEnds.BitmapFrontEnd","clearUnused",0x9cfedd10,"flixel.system.frontEnds.BitmapFrontEnd.clearUnused","flixel/system/frontEnds/BitmapFrontEnd.hx",383,0x91a05ae2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_401_get_whitePixel,"flixel.system.frontEnds.BitmapFrontEnd","get_whitePixel",0xa476cef9,"flixel.system.frontEnds.BitmapFrontEnd.get_whitePixel","flixel/system/frontEnds/BitmapFrontEnd.hx",401,0x91a05ae2)
namespace flixel{
...
HXLINE( 196)				if (hx::IsEq( ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) )->bitmap,bmd )) {
HXLINE( 197)					return key1;
            				}
            			}
            		}
...
::String BitmapFrontEnd_obj::getKeyForClass(hx::Class source){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_210_getKeyForClass)
HXDLIN( 210)		return ::Type_obj::getClassName(source);
            	}
...
::String BitmapFrontEnd_obj::generateKey(::String systemKey,::String userKey,hx::Null< bool >  __o_unique){
            		bool unique = __o_unique.Default(false);
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_222_generateKey)
HXLINE( 223)		::String key = userKey;
HXLINE( 224)		if (hx::IsNull( key )) {
HXLINE( 225)			key = systemKey;
            		}
HXLINE( 227)		bool _hx_tmp;
HXDLIN( 227)		if (!(unique)) {
HXLINE( 227)			_hx_tmp = hx::IsNull( key );
            		}
            		else {
HXLINE( 227)			_hx_tmp = true;
            		}
HXDLIN( 227)		if (_hx_tmp) {
HXLINE( 228)			key = this->getUniqueKey(key);
            		}
HXLINE( 230)		return key;
            	}
...
::String BitmapFrontEnd_obj::getUniqueKey(::String baseKey){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_240_getUniqueKey)
HXLINE( 241)		if (hx::IsNull( baseKey )) {
HXLINE( 242)			baseKey = HX_("pixels",2d,ef,a9,8c);
            		}
HXLINE( 244)		if (hx::IsNull( ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(baseKey)) ) )) {
HXLINE( 245)			return baseKey;
            		}
HXLINE( 247)		int i = this->_lastUniqueKeyIndex;
HXLINE( 248)		::String uniqueKey;
HXLINE( 249)		while(true){
HXLINE( 251)			i = (i + 1);
HXLINE( 252)			uniqueKey = (baseKey + i);
HXLINE( 249)			if (!(hx::IsNotNull( ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(uniqueKey)) ) ))) {
HXLINE( 249)				goto _hx_goto_18;
            			}
            		}
            		_hx_goto_18:;
HXLINE( 256)		this->_lastUniqueKeyIndex = i;
HXLINE( 257)		return uniqueKey;
            	}
...
::String BitmapFrontEnd_obj::getKeyWithSpacesAndBorders(::String baseKey, ::flixel::math::FlxPoint frameSize, ::flixel::math::FlxPoint frameSpacing, ::flixel::math::FlxPoint frameBorder, ::flixel::math::FlxRect region){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_271_getKeyWithSpacesAndBorders)
HXLINE( 272)		::String result = baseKey;
HXLINE( 274)		if (hx::IsNotNull( region )) {
HXLINE( 275)			result = (result + (((((((HX_("_Region:",27,96,a5,81) + region->x) + HX_("_",5f,00,00,00)) + region->y) + HX_("_",5f,00,00,00)) + region->width) + HX_("_",5f,00,00,00)) + region->height));
            		}
HXLINE( 277)		if (hx::IsNotNull( frameSize )) {
HXLINE( 278)			result = (result + (((HX_("_FrameSize:",2b,0e,3a,29) + frameSize->x) + HX_("_",5f,00,00,00)) + frameSize->y));
            		}
HXLINE( 280)		if (hx::IsNotNull( frameSpacing )) {
HXLINE( 281)			result = (result + (((HX_("_Spaces:",0e,b0,c1,98) + frameSpacing->x) + HX_("_",5f,00,00,00)) + frameSpacing->y));
            		}
HXLINE( 283)		if (hx::IsNotNull( frameBorder )) {
HXLINE( 284)			result = (result + (((HX_("_Border:",2f,83,f2,39) + frameBorder->x) + HX_("_",5f,00,00,00)) + frameBorder->y));
            		}
...
void BitmapFrontEnd_obj::remove( ::flixel::graphics::FlxGraphic graphic){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_295_remove)
HXDLIN( 295)		if (hx::IsNotNull( graphic )) {
HXLINE( 297)			{
HXLINE( 297)				::String key = graphic->key;
HXDLIN( 297)				if (hx::IsNotNull( key )) {
HXLINE( 297)					::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,key);
HXDLIN( 297)					this->_cache->remove(key);
            				}
            			}
HXLINE( 298)			graphic->destroy();
            		}
            	}
...
void BitmapFrontEnd_obj::removeByKey(::String key){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_308_removeByKey)
HXDLIN( 308)		if (hx::IsNotNull( key )) {
HXLINE( 310)			 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key)) );
HXLINE( 311)			if (hx::IsNotNull( key )) {
HXLINE( 311)				::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,key);
HXDLIN( 311)				this->_cache->remove(key);
            			}
HXLINE( 313)			if (hx::IsNotNull( obj )) {
HXLINE( 314)				obj->destroy();
            			}
            		}
            	}
...
void BitmapFrontEnd_obj::removeIfNoUse( ::flixel::graphics::FlxGraphic graphic){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_320_removeIfNoUse)
HXDLIN( 320)		bool _hx_tmp;
HXDLIN( 320)		bool _hx_tmp1;
HXDLIN( 320)		if (hx::IsNotNull( graphic )) {
HXDLIN( 320)			_hx_tmp1 = (graphic->get_useCount() == 0);
            		}
            		else {
HXDLIN( 320)			_hx_tmp1 = false;
            		}
HXDLIN( 320)		if (_hx_tmp1) {
HXDLIN( 320)			_hx_tmp = !(graphic->persist);
            		}
            		else {
HXDLIN( 320)			_hx_tmp = false;
            		}
HXDLIN( 320)		if (_hx_tmp) {
HXLINE( 321)			this->remove(graphic);
            		}
            	}
...
void BitmapFrontEnd_obj::clearCache(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_329_clearCache)
HXLINE( 330)		if (hx::IsNull( this->_cache )) {
HXLINE( 332)			this->_cache =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 333)			return;
            		}
HXLINE( 336)		{
HXLINE( 336)			 ::Dynamic key = this->_cache->keys();
...
HXLINE( 338)				 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
HXLINE( 339)				bool _hx_tmp;
HXDLIN( 339)				bool _hx_tmp1;
HXDLIN( 339)				if (hx::IsNotNull( obj )) {
HXLINE( 339)					_hx_tmp1 = !(obj->persist);
            				}
            				else {
HXLINE( 339)					_hx_tmp1 = false;
            				}
HXDLIN( 339)				if (_hx_tmp1) {
HXLINE( 339)					_hx_tmp = (obj->get_useCount() <= 0);
            				}
            				else {
HXLINE( 339)					_hx_tmp = false;
            				}
HXDLIN( 339)				if (_hx_tmp) {
HXLINE( 341)					if (hx::IsNotNull( key1 )) {
HXLINE( 341)						::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,key1);
HXDLIN( 341)						this->_cache->remove(key1);
            					}
HXLINE( 342)					obj->destroy();
            				}
            			}
            		}
            	}
...
void BitmapFrontEnd_obj::removeKey(::String key){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_349_removeKey)
HXDLIN( 349)		if (hx::IsNotNull( key )) {
HXLINE( 351)			::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,key);
HXLINE( 352)			this->_cache->remove(key);
            		}
            	}
...
void BitmapFrontEnd_obj::reset(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_360_reset)
HXLINE( 361)		if (hx::IsNull( this->_cache )) {
HXLINE( 363)			this->_cache =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 364)			return;
            		}
HXLINE( 367)		{
HXLINE( 367)			 ::Dynamic key = this->_cache->keys();
HXDLIN( 367)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 367)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 369)				 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
HXLINE( 370)				if (hx::IsNotNull( key1 )) {
HXLINE( 370)					::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,key1);
HXDLIN( 370)					this->_cache->remove(key1);
            				}
HXLINE( 372)				if (hx::IsNotNull( obj )) {
HXLINE( 373)					obj->destroy();
            				}
            			}
            		}
            	}
...
void BitmapFrontEnd_obj::clearUnused(){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_383_clearUnused)
HXDLIN( 383)		 ::Dynamic key = this->_cache->keys();
HXDLIN( 383)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXDLIN( 383)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 385)			 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
HXLINE( 386)			bool _hx_tmp;
HXDLIN( 386)			bool _hx_tmp1;
HXDLIN( 386)			bool _hx_tmp2;
HXDLIN( 386)			if (hx::IsNotNull( obj )) {
HXLINE( 386)				_hx_tmp2 = (obj->get_useCount() <= 0);
            			}
            			else {
HXLINE( 386)				_hx_tmp2 = false;
            			}
HXDLIN( 386)			if (_hx_tmp2) {
HXLINE( 386)				_hx_tmp1 = !(obj->persist);
            			}
            			else {
HXLINE( 386)				_hx_tmp1 = false;
            			}
HXDLIN( 386)			if (_hx_tmp1) {
HXLINE( 386)				_hx_tmp = obj->get_destroyOnNoUse();
            			}
            			else {
HXLINE( 386)				_hx_tmp = false;
            			}
HXDLIN( 386)			if (_hx_tmp) {
HXLINE( 388)				this->removeByKey(key1);
            			}
            		}
            	}
...
HXDLIN( 396)		return ( (int)(::lime::graphics::opengl::GL_obj::context->getParameter(3379)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapFrontEnd_obj,get_maxTextureSize,return )
 ...
 ::flixel::graphics::frames::FlxFrame BitmapFrontEnd_obj::get_whitePixel(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_401_get_whitePixel)
HXLINE( 402)		if (hx::IsNull( this->_whitePixel )) {
HXLINE( 404)			 ::openfl::display::BitmapData bd =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,10,10,true,-1);
HXLINE( 405)			 ::flixel::graphics::FlxGraphic graphic = ::flixel::FlxG_obj::bitmap->add(bd,true,HX_("whitePixels",b6,92,ba,9e));
HXLINE( 406)			graphic->persist = true;
HXLINE( 407)			this->_whitePixel = graphic->get_imageFrame()->get_frame();
            		}
HXLINE( 410)		return this->_whitePixel;
            	}
