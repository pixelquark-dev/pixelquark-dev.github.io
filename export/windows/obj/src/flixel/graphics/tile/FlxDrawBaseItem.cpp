...
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_16_new,"flixel.graphics.tile.FlxDrawBaseItem","new",0x1069797d,"flixel.graphics.tile.FlxDrawBaseItem.new","flixel/graphics/tile/FlxDrawBaseItem.hx",16,0xe6349cf4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_26_blendToInt,"flixel.graphics.tile.FlxDrawBaseItem","blendToInt",0xc101e4a6,"flixel.graphics.tile.FlxDrawBaseItem.blendToInt","flixel/graphics/tile/FlxDrawBaseItem.hx",26,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_21_boot,"flixel.graphics.tile.FlxDrawBaseItem","boot",0x43f9d475,"flixel.graphics.tile.FlxDrawBaseItem.boot","flixel/graphics/tile/FlxDrawBaseItem.hx",21,0xe6349cf4)
namespace flixel{
namespace graphics{
namespace tile{

void FlxDrawBaseItem_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_16_new)
HXLINE(  71)		this->blending = 0;
HXLINE(  70)		this->hasColorOffsets = false;
HXLINE(  69)		this->colored = false;
...
int FlxDrawBaseItem_obj::blendToInt( ::Dynamic blend){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_26_blendToInt)
HXDLIN(  26)		return 0;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_21_boot)
HXDLIN(  21)		drawCalls = 0;
            	}
}
