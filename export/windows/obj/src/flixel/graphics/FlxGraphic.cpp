...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_425_undump,"flixel.graphics.FlxGraphic","undump",0xf6fcc174,"flixel.graphics.FlxGraphic.undump","flixel/graphics/FlxGraphic.hx",425,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_439_onContext,"flixel.graphics.FlxGraphic","onContext",0x4fa62b89,"flixel.graphics.FlxGraphic.onContext","flixel/graphics/FlxGraphic.hx",439,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_451_onAssetsReload,"flixel.graphics.FlxGraphic","onAssetsReload",0x9c63b062,"flixel.graphics.FlxGraphic.onAssetsReload","flixel/graphics/FlxGraphic.hx",451,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_465_destroy,"flixel.graphics.FlxGraphic","destroy",0x6c66a9b3,"flixel.graphics.FlxGraphic.destroy","flixel/graphics/FlxGraphic.hx",465,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_501_addFrameCollection,"flixel.graphics.FlxGraphic","addFrameCollection",0x06dd03b1,"flixel.graphics.FlxGraphic.addFrameCollection","flixel/graphics/FlxGraphic.hx",501,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_515_getFramesCollections,"flixel.graphics.FlxGraphic","getFramesCollections",0xa4089c80,"flixel.graphics.FlxGraphic.getFramesCollections","flixel/graphics/FlxGraphic.hx",515,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_533_getEmptyFrame,"flixel.graphics.FlxGraphic","getEmptyFrame",0xc5b0f80f,"flixel.graphics.FlxGraphic.getEmptyFrame","flixel/graphics/FlxGraphic.hx",533,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_569_getBitmapFromSystem,"flixel.graphics.FlxGraphic","getBitmapFromSystem",0xb3be27b7,"flixel.graphics.FlxGraphic.getBitmapFromSystem","flixel/graphics/FlxGraphic.hx",569,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_584_get_canBeDumped,"flixel.graphics.FlxGraphic","get_canBeDumped",0x9b8a5e36,"flixel.graphics.FlxGraphic.get_canBeDumped","flixel/graphics/FlxGraphic.hx",584,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_589_get_useCount,"flixel.graphics.FlxGraphic","get_useCount",0x2bcc1fb8,"flixel.graphics.FlxGraphic.get_useCount","flixel/graphics/FlxGraphic.hx",589,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_593_set_useCount,"flixel.graphics.FlxGraphic","set_useCount",0x40c5432c,"flixel.graphics.FlxGraphic.set_useCount","flixel/graphics/FlxGraphic.hx",593,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_602_get_destroyOnNoUse,"flixel.graphics.FlxGraphic","get_destroyOnNoUse",0x7e860bbd,"flixel.graphics.FlxGraphic.get_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",602,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_606_set_destroyOnNoUse,"flixel.graphics.FlxGraphic","set_destroyOnNoUse",0x5b353e31,"flixel.graphics.FlxGraphic.set_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",606,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_614_get_imageFrame,"flixel.graphics.FlxGraphic","get_imageFrame",0xc1224382,"flixel.graphics.FlxGraphic.get_imageFrame","flixel/graphics/FlxGraphic.hx",614,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_623_get_atlasFrames,"flixel.graphics.FlxGraphic","get_atlasFrames",0x774c10a1,"flixel.graphics.FlxGraphic.get_atlasFrames","flixel/graphics/FlxGraphic.hx",623,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_627_set_bitmap,"flixel.graphics.FlxGraphic","set_bitmap",0x39ee9b13,"flixel.graphics.FlxGraphic.set_bitmap","flixel/graphics/FlxGraphic.hx",627,0xb3633517)
...
HXLINE( 364)		this->unique = false;
HXLINE( 311)		this->isDumped = false;
HXLINE( 300)		this->persist = false;
...
HXLINE( 402)		this->shader =  ::flixel::graphics::tile::FlxGraphicsShader_obj::__alloc( HX_CTX );
            	}
...
void FlxGraphic_obj::undump(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_425_undump)
HXLINE( 426)		 ::openfl::display::BitmapData newBitmap = this->getBitmapFromSystem();
HXLINE( 427)		if (hx::IsNotNull( newBitmap )) {
HXLINE( 428)			this->set_bitmap(newBitmap);
            		}
HXLINE( 429)		this->isDumped = false;
            	}
...
void FlxGraphic_obj::onContext(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_439_onContext)
HXDLIN( 439)		if (this->isDumped) {
HXLINE( 441)			this->undump();
HXLINE( 442)			this->dump();
            		}
            	}
...
void FlxGraphic_obj::onAssetsReload(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_451_onAssetsReload)
HXLINE( 452)		bool _hx_tmp;
HXDLIN( 452)		if (hx::IsNull( this->assetsClass )) {
HXLINE( 452)			_hx_tmp = hx::IsNotNull( this->assetsKey );
            		}
            		else {
...
HXLINE( 455)		bool dumped = this->isDumped;
HXLINE( 456)		this->undump();
HXLINE( 457)		if (dumped) {
HXLINE( 458)			this->dump();
            		}
            	}
...
void FlxGraphic_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_465_destroy)
HXLINE( 466)		this->set_bitmap(::flixel::util::FlxDestroyUtil_obj::dispose(this->bitmap));
HXLINE( 469)		this->shader = null();
HXLINE( 475)		this->key = null();
HXLINE( 476)		this->assetsKey = null();
HXLINE( 477)		this->assetsClass = null();
HXLINE( 478)		this->_imageFrame = null();
HXLINE( 480)		if (hx::IsNull( this->frameCollections )) {
HXLINE( 481)			return;
            		}
HXLINE( 483)		::Array< ::Dynamic> collections;
HXLINE( 484)		{
HXLINE( 484)			int _g = 0;
HXDLIN( 484)			::Array< ::Dynamic> _g1 = this->frameCollectionTypes;
HXDLIN( 484)			while((_g < _g1->length)){
HXLINE( 484)				 ::flixel::graphics::frames::FlxFrameCollectionType collectionType = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrameCollectionType >();
HXDLIN( 484)				_g = (_g + 1);
HXLINE( 486)				collections = ( (::Array< ::Dynamic>)(this->frameCollections->get(collectionType)) );
HXLINE( 487)				::flixel::util::FlxDestroyUtil_obj::destroyArray(collections);
            			}
            		}
HXLINE( 490)		this->frameCollections = null();
HXLINE( 491)		this->frameCollectionTypes = null();
            	}
...
void FlxGraphic_obj::addFrameCollection( ::flixel::graphics::frames::FlxFramesCollection collection){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_501_addFrameCollection)
HXDLIN( 501)		if (hx::IsNotNull( collection->type )) {
HXLINE( 503)			 ::flixel::graphics::frames::FlxFrameCollectionType type = collection->type;
HXDLIN( 503)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
HXDLIN( 503)			if (hx::IsNull( collections )) {
HXLINE( 503)				collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 503)				this->frameCollections->set(type,collections);
            			}
HXDLIN( 503)			::cpp::VirtualArray collections1 = collections;
HXLINE( 504)			collections1->push(collection);
            		}
            	}
...
::cpp::VirtualArray FlxGraphic_obj::getFramesCollections( ::flixel::graphics::frames::FlxFrameCollectionType type){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_515_getFramesCollections)
HXLINE( 516)		::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
HXLINE( 517)		if (hx::IsNull( collections )) {
HXLINE( 519)			collections = ::Array_obj< ::Dynamic>::__new();
HXLINE( 520)			this->frameCollections->set(type,collections);
            		}
HXLINE( 522)		return collections;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getFramesCollections,return )
 ...
 ::flixel::graphics::frames::FlxFrame FlxGraphic_obj::getEmptyFrame( ::flixel::math::FlxPoint size){
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_533_getEmptyFrame)
HXLINE( 534)		 ::flixel::graphics::frames::FlxFrame frame =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),null(),null(),null());
HXLINE( 535)		frame->type = 2;
HXLINE( 536)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 536)		_this->x = ( (Float)(0) );
HXDLIN( 536)		_this->y = ( (Float)(0) );
HXDLIN( 536)		_this->width = ( (Float)(0) );
HXDLIN( 536)		_this->height = ( (Float)(0) );
HXDLIN( 536)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 536)		rect->_inPool = false;
HXDLIN( 536)		frame->set_frame(rect);
HXLINE( 537)		{
HXLINE( 537)			 ::flixel::math::FlxPoint _this1 = frame->sourceSize;
HXDLIN( 537)			_this1->set_x(size->x);
HXDLIN( 537)			_this1->set_y(size->y);
HXDLIN( 537)			if (size->_weak) {
HXLINE( 537)				size->put();
            			}
            		}
HXLINE( 538)		return frame;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getEmptyFrame,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::getBitmapFromSystem(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_569_getBitmapFromSystem)
HXLINE( 570)		 ::openfl::display::BitmapData newBitmap = null();
HXLINE( 571)		if (hx::IsNotNull( this->assetsClass )) {
HXLINE( 572)			newBitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(this->assetsClass,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) );
            		}
            		else {
HXLINE( 573)			if (hx::IsNotNull( this->assetsKey )) {
HXLINE( 574)				::String id = this->assetsKey;
HXDLIN( 574)				if (::openfl::utils::Assets_obj::exists(id,null())) {
HXLINE( 574)					newBitmap = ::openfl::utils::Assets_obj::getBitmapData(id,false);
            				}
            				else {
HXLINE( 574)					::flixel::FlxG_obj::log->advanced(((HX_("Could not find a BitmapData asset with ID '",5f,79,a9,21) + id) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
HXDLIN( 574)					newBitmap = null();
            				}
            			}
            		}
HXLINE( 576)		if (hx::IsNotNull( newBitmap )) {
HXLINE( 577)			if (this->unique) {
HXLINE( 577)				return newBitmap->clone();
            			}
            			else {
HXLINE( 577)				return newBitmap;
            			}
            		}
...
bool FlxGraphic_obj::get_canBeDumped(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_584_get_canBeDumped)
HXDLIN( 584)		if (hx::IsNull( this->assetsClass )) {
HXDLIN( 584)			return hx::IsNotNull( this->assetsKey );
            		}
            		else {
...
int FlxGraphic_obj::get_useCount(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_589_get_useCount)
HXDLIN( 589)		return this->_useCount;
            	}
...
int FlxGraphic_obj::set_useCount(int Value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_593_set_useCount)
HXLINE( 594)		bool _hx_tmp;
HXDLIN( 594)		bool _hx_tmp1;
HXDLIN( 594)		if ((Value <= 0)) {
HXLINE( 594)			_hx_tmp1 = this->_destroyOnNoUse;
            		}
            		else {
HXLINE( 594)			_hx_tmp1 = false;
            		}
HXDLIN( 594)		if (_hx_tmp1) {
HXLINE( 594)			_hx_tmp = !(this->persist);
            		}
            		else {
HXLINE( 594)			_hx_tmp = false;
            		}
HXDLIN( 594)		if (_hx_tmp) {
HXLINE( 595)			::flixel::FlxG_obj::bitmap->remove(hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 597)		return (this->_useCount = Value);
            	}
...
bool FlxGraphic_obj::get_destroyOnNoUse(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_602_get_destroyOnNoUse)
HXDLIN( 602)		return this->_destroyOnNoUse;
            	}
...
bool FlxGraphic_obj::set_destroyOnNoUse(bool Value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_606_set_destroyOnNoUse)
HXLINE( 607)		bool _hx_tmp;
HXDLIN( 607)		bool _hx_tmp1;
HXDLIN( 607)		bool _hx_tmp2;
HXDLIN( 607)		if (Value) {
HXLINE( 607)			_hx_tmp2 = (this->_useCount <= 0);
            		}
            		else {
HXLINE( 607)			_hx_tmp2 = false;
            		}
HXDLIN( 607)		if (_hx_tmp2) {
HXLINE( 607)			_hx_tmp1 = hx::IsNotNull( this->key );
            		}
            		else {
HXLINE( 607)			_hx_tmp1 = false;
            		}
HXDLIN( 607)		if (_hx_tmp1) {
HXLINE( 607)			_hx_tmp = !(this->persist);
            		}
            		else {
HXLINE( 607)			_hx_tmp = false;
            		}
HXDLIN( 607)		if (_hx_tmp) {
HXLINE( 608)			::flixel::FlxG_obj::bitmap->remove(hx::ObjectPtr<OBJ_>(this));
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,set_destroyOnNoUse,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxGraphic_obj::get_imageFrame(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_614_get_imageFrame)
HXLINE( 615)		if (hx::IsNull( this->_imageFrame )) {
HXLINE( 616)			Float Width = ( (Float)(this->bitmap->width) );
HXDLIN( 616)			Float Height = ( (Float)(this->bitmap->height) );
HXDLIN( 616)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 616)			_this->x = ( (Float)(0) );
HXDLIN( 616)			_this->y = ( (Float)(0) );
...
HXLINE( 618)		return this->_imageFrame;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_imageFrame,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxGraphic_obj::get_atlasFrames(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_623_get_atlasFrames)
HXDLIN( 623)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(hx::ObjectPtr<OBJ_>(this),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_atlasFrames,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::set_bitmap( ::openfl::display::BitmapData value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_627_set_bitmap)
HXLINE( 628)		if (hx::IsNotNull( value )) {
HXLINE( 630)			this->bitmap = value;
HXLINE( 631)			this->width = this->bitmap->width;
HXLINE( 632)			this->height = this->bitmap->height;
            		}
