...
HX_DEFINE_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_655_new,"flixel.ui._FlxButton.FlxButtonEvent","new",0xea40fb69,"flixel.ui._FlxButton.FlxButtonEvent.new","flixel/ui/FlxButton.hx",655,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_667_destroy,"flixel.ui._FlxButton.FlxButtonEvent","destroy",0x72801083,"flixel.ui._FlxButton.FlxButtonEvent.destroy","flixel/ui/FlxButton.hx",667,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_679_fire,"flixel.ui._FlxButton.FlxButtonEvent","fire",0x0954508d,"flixel.ui._FlxButton.FlxButtonEvent.fire","flixel/ui/FlxButton.hx",679,0xc64cf442)
namespace flixel{
namespace ui{
namespace _FlxButton{

void FlxButtonEvent_obj::__construct( ::Dynamic Callback, ::flixel::_hx_system::FlxSound sound){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_655_new)
HXLINE( 656)		this->callback = Callback;
HXLINE( 659)		this->sound = sound;
            	}
...
void FlxButtonEvent_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_667_destroy)
HXLINE( 668)		this->callback = null();
HXLINE( 671)		this->sound = ( ( ::flixel::_hx_system::FlxSound)(::flixel::util::FlxDestroyUtil_obj::destroy(this->sound)) );
            	}
...
void FlxButtonEvent_obj::fire(){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_679_fire)
HXLINE( 680)		if (hx::IsNotNull( this->callback )) {
HXLINE( 681)			this->callback();
            		}
HXLINE( 684)		if (hx::IsNotNull( this->sound )) {
HXLINE( 685)			this->sound->play(true,null(),null());
            		}
            	}
