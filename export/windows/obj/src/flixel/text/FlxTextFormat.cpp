...
HX_DEFINE_STACK_FRAME(_hx_pos_a69907c6a733237a_1064_new,"flixel.text.FlxTextFormat","new",0x67be2279,"flixel.text.FlxTextFormat.new","flixel/text/FlxText.hx",1064,0xdf165a6e)
namespace flixel{
namespace text{

void FlxTextFormat_obj::__construct( ::Dynamic FontColor, ::Dynamic Bold, ::Dynamic Italic, ::Dynamic BorderColor){
            	HX_GC_STACKFRAME(&_hx_pos_a69907c6a733237a_1064_new)
HXLINE(1065)		this->format =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,null(),null(),FontColor,Bold,Italic,null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(1066)		int _hx_tmp;
HXDLIN(1066)		if (hx::IsNull( BorderColor )) {
HXLINE(1066)			_hx_tmp = 0;
            		}
            		else {
HXLINE(1066)			_hx_tmp = ( (int)(BorderColor) );
            		}
HXDLIN(1066)		this->borderColor = _hx_tmp;
            	}
