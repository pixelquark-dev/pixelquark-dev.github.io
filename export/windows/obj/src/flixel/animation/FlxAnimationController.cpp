...
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_775_get_curAnim,"flixel.animation.FlxAnimationController","get_curAnim",0xd32cfb64,"flixel.animation.FlxAnimationController.get_curAnim","flixel/animation/FlxAnimationController.hx",775,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_779_set_curAnim,"flixel.animation.FlxAnimationController","set_curAnim",0xdd9a0270,"flixel.animation.FlxAnimationController.set_curAnim","flixel/animation/FlxAnimationController.hx",779,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_796_get_paused,"flixel.animation.FlxAnimationController","get_paused",0x1a2b745b,"flixel.animation.FlxAnimationController.get_paused","flixel/animation/FlxAnimationController.hx",796,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_806_set_paused,"flixel.animation.FlxAnimationController","set_paused",0x1da912cf,"flixel.animation.FlxAnimationController.set_paused","flixel/animation/FlxAnimationController.hx",806,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_822_get_finished,"flixel.animation.FlxAnimationController","get_finished",0x1eabcc5f,"flixel.animation.FlxAnimationController.get_finished","flixel/animation/FlxAnimationController.hx",822,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_832_set_finished,"flixel.animation.FlxAnimationController","set_finished",0x33a4efd3,"flixel.animation.FlxAnimationController.set_finished","flixel/animation/FlxAnimationController.hx",832,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_842_get_frames,"flixel.animation.FlxAnimationController","get_frames",0xd72ce353,"flixel.animation.FlxAnimationController.get_frames","flixel/animation/FlxAnimationController.hx",842,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_853_getFrameIndex,"flixel.animation.FlxAnimationController","getFrameIndex",0x1c3dee77,"flixel.animation.FlxAnimationController.getFrameIndex","flixel/animation/FlxAnimationController.hx",853,0xa6f01372)
namespace flixel{
namespace animation{
...
HX_DEFINE_DYNAMIC_FUNC1(FlxAnimationController_obj,set_name,return )
 ...
 ::flixel::animation::FlxAnimation FlxAnimationController_obj::get_curAnim(){
            	HX_STACKFRAME(&_hx_pos_5ed655cc53689dfd_775_get_curAnim)
HXDLIN( 775)		return this->_curAnim;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxAnimationController_obj,get_curAnim,return )
 ...
 ::flixel::animation::FlxAnimation FlxAnimationController_obj::set_curAnim( ::flixel::animation::FlxAnimation Anim){
            	HX_STACKFRAME(&_hx_pos_5ed655cc53689dfd_779_set_curAnim)
HXLINE( 780)		if (hx::IsNotEq( Anim,this->_curAnim )) {
HXLINE( 782)			if (hx::IsNotNull( this->_curAnim )) {
HXLINE( 784)				this->_curAnim->stop();
            			}
HXLINE( 787)			if (hx::IsNotNull( Anim )) {
HXLINE( 789)				Anim->play(null(),null(),null());
            			}
            		}
HXLINE( 792)		return (this->_curAnim = Anim);
            	}
...
bool FlxAnimationController_obj::get_paused(){
            	HX_STACKFRAME(&_hx_pos_5ed655cc53689dfd_796_get_paused)
HXLINE( 797)		bool paused = false;
HXLINE( 798)		if (hx::IsNotNull( this->_curAnim )) {
HXLINE( 800)			paused = this->_curAnim->paused;
            		}
HXLINE( 802)		return paused;
            	}
...
bool FlxAnimationController_obj::set_paused(bool Value){
            	HX_STACKFRAME(&_hx_pos_5ed655cc53689dfd_806_set_paused)
HXLINE( 807)		if (hx::IsNotNull( this->_curAnim )) {
HXLINE( 809)			if (Value) {
HXLINE( 811)				this->_curAnim->pause();
            			}
            			else {
HXLINE( 815)				this->_curAnim->paused = false;
            			}
            		}
...
bool FlxAnimationController_obj::get_finished(){
            	HX_STACKFRAME(&_hx_pos_5ed655cc53689dfd_822_get_finished)
HXLINE( 823)		bool finished = true;
HXLINE( 824)		if (hx::IsNotNull( this->_curAnim )) {
HXLINE( 826)			finished = this->_curAnim->finished;
            		}
HXLINE( 828)		return finished;
            	}
...
bool FlxAnimationController_obj::set_finished(bool Value){
            	HX_STACKFRAME(&_hx_pos_5ed655cc53689dfd_832_set_finished)
HXLINE( 833)		bool _hx_tmp;
HXDLIN( 833)		if (Value) {
HXLINE( 833)			_hx_tmp = hx::IsNotNull( this->_curAnim );
            		}
            		else {
HXLINE( 833)			_hx_tmp = false;
            		}
HXDLIN( 833)		if (_hx_tmp) {
HXLINE( 835)			this->_curAnim->finish();
            		}
HXLINE( 837)		return Value;
            	}
...
int FlxAnimationController_obj::get_frames(){
            	HX_STACKFRAME(&_hx_pos_5ed655cc53689dfd_842_get_frames)
HXDLIN( 842)		return this->_sprite->numFrames;
            	}
...
int FlxAnimationController_obj::getFrameIndex( ::flixel::graphics::frames::FlxFrame Frame){
            	HX_STACKFRAME(&_hx_pos_5ed655cc53689dfd_853_getFrameIndex)
HXDLIN( 853)		return this->_sprite->frames->frames->indexOf(Frame,null());
            	}
