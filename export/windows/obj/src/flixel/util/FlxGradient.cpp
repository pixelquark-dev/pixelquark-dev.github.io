...
HXLINE( 132)			int int3 = height;
HXDLIN( 132)			Float tempBitmap;
HXDLIN( 132)			if ((int3 < 0)) {
HXLINE( 132)				tempBitmap = (((Float)4294967296.0) + int3);
            			}
            			else {
HXLINE( 132)				tempBitmap = (int3 + ((Float)0.0));
            			}
HXDLIN( 132)			int int4 = chunkSize;
HXDLIN( 132)			Float tempBitmap1;
HXDLIN( 132)			if ((int4 < 0)) {
HXLINE( 132)				tempBitmap1 = (((Float)4294967296.0) + int4);
            			}
            			else {
HXLINE( 132)				tempBitmap1 = (int4 + ((Float)0.0));
            			}
...
HXLINE( 134)			int int5 = chunkSize;
HXDLIN( 134)			Float _hx_tmp6;
HXDLIN( 134)			if ((int5 < 0)) {
HXLINE( 134)				_hx_tmp6 = (((Float)4294967296.0) + int5);
            			}
            			else {
HXLINE( 134)				_hx_tmp6 = (int5 + ((Float)0.0));
            			}
HXDLIN( 134)			tempBitmap2->set_scaleY(_hx_tmp6);
HXLINE( 136)			 ::openfl::geom::Matrix sM =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 137)			Float _hx_tmp7 = tempBitmap2->get_scaleX();
HXDLIN( 137)			sM->scale(_hx_tmp7,tempBitmap2->get_scaleY());
