...
HXLINE( 522)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->removeHandle(curl1);
HXLINE( 523)					curl1->cleanup();
...
HXLINE( 585)				 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 585)				instance2->error(::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)) )));
            			}
