...
HXLINE(  69)				 ::Dynamic value1 = ::haxe::Log_obj::trace;
HXDLIN(  69)				value1(::Std_obj::string(v),inf);
            			}
...
HXLINE( 323)				return this->resolve(id);
            			...
            			break;
            			case (int)2: {
HXLINE( 324)				 ::hscript::CType _g32 = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
...
HXLINE( 393)				 ::hscript::CType _g44 = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
...
HXLINE( 463)						 ::hscript::Expr _g31 = _g3->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 463)						 ::hscript::Expr _g22 = _g3->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 463)						if ((_g3->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXDLIN( 470)						while((_g4 < arr1->length)){
HXLINE( 470)							 ::hscript::Expr e18 = arr1->__get(_g4).StaticCast<  ::hscript::Expr >();
HXDLIN( 470)							_g4 = (_g4 + 1);
HXLINE( 471)							if ((e18->_hx_getIndex() == 6)) {
HXLINE( 472)								if ((e18->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXLINE( 492)					{
HXLINE( 492)						int _g5 = 0;
HXDLIN( 492)						int _g6 = keys->get_length();
HXDLIN( 492)						while((_g5 < _g6)){
HXLINE( 492)							_g5 = (_g5 + 1);
HXDLIN( 492)							int n1 = (_g5 - 1);
...
HXLINE( 499)					{
HXLINE( 499)						int _g41 = 0;
HXDLIN( 499)						while((_g41 < arr1->length)){
HXLINE( 499)							 ::hscript::Expr e19 = arr1->__get(_g41).StaticCast<  ::hscript::Expr >();
HXDLIN( 499)							_g41 = (_g41 + 1);
...
HXLINE( 515)				{
HXLINE( 515)					int _g7 = 0;
HXDLIN( 515)					while((_g7 < params2->length)){
HXLINE( 515)						 ::hscript::Expr e20 = params2->__get(_g7).StaticCast<  ::hscript::Expr >();
HXDLIN( 515)						_g7 = (_g7 + 1);
...
HXLINE( 519)				HX_STACK_DO_THROW(this->expr(e23));
            			...
            			break;
            			case (int)20: {
HXLINE( 520)				 ::hscript::CType _g51 = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
...
HXLINE( 537)						::Array< ::Dynamic> _hx_tmp5 = this->declared;
HXDLIN( 537)						_hx_tmp5->push( ::Dynamic(hx::Anon_obj::Create(2)
...
HXLINE( 545)				{
HXLINE( 545)					int _g8 = 0;
HXDLIN( 545)					while((_g8 < fl->length)){
HXLINE( 545)						 ::Dynamic f5 = fl->__get(_g8);
HXDLIN( 545)						_g8 = (_g8 + 1);
...
HXLINE( 553)				{
HXLINE( 553)					int _g9 = 0;
HXDLIN( 553)					while((_g9 < cases->length)){
HXLINE( 553)						 ::Dynamic c1 = cases->__get(_g9);
HXDLIN( 553)						_g9 = (_g9 + 1);
HXLINE( 554)						{
HXLINE( 554)							int _g10 = 0;
HXDLIN( 554)							::Array< ::Dynamic> _g13 = ( (::Array< ::Dynamic>)(c1->__Field(HX_("values",e2,03,b7,4f),hx::paccDynamic)) );
HXDLIN( 554)							while((_g10 < _g13->length)){
HXLINE( 554)								 ::hscript::Expr v5 = _g13->__get(_g10).StaticCast<  ::hscript::Expr >();
HXDLIN( 554)								_g10 = (_g10 + 1);
...
HXLINE( 382)				return null();
            			...
            			break;
            			case (int)25: {
HXLINE( 567)				::Array< ::Dynamic> _g52 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 567)				::String _g511 = e->_hx_getString(0);
HXDLIN( 567)				 ::hscript::Expr e28 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 568)				return this->expr(e28);
            			}
            			break;
            			case (int)26: {
HXLINE( 569)				 ::hscript::CType _g46 = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 569)				 ::hscript::Expr e29 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
