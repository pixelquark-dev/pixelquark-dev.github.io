...
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_255_attachNetStream,"openfl.media.Video","attachNetStream",0xc6ae0d3d,"openfl.media.Video.attachNetStream","openfl/media/Video.hx",255,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_272_clear,"openfl.media.Video","clear",0xc14cb652,"openfl.media.Video.clear","openfl/media/Video.hx",272,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_275___enterFrame,"openfl.media.Video","__enterFrame",0x9c348cf0,"openfl.media.Video.__enterFrame","openfl/media/Video.hx",275,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_285___getBounds,"openfl.media.Video","__getBounds",0x07e0ff10,"openfl.media.Video.__getBounds","openfl/media/Video.hx",285,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_296___getIndexBuffer,"openfl.media.Video","__getIndexBuffer",0xdda0db37,"openfl.media.Video.__getIndexBuffer","openfl/media/Video.hx",296,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_343___getTexture,"openfl.media.Video","__getTexture",0x8826d7e0,"openfl.media.Video.__getTexture","openfl/media/Video.hx",343,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_348___getVertexBuffer,"openfl.media.Video","__getVertexBuffer",0x83d60e5f,"openfl.media.Video.__getVertexBuffer","openfl/media/Video.hx",348,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_395___hitTest,"openfl.media.Video","__hitTest",0x56a13c6a,"openfl.media.Video.__hitTest","openfl/media/Video.hx",395,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_418___hitTestMask,"openfl.media.Video","__hitTestMask",0x01982676,"openfl.media.Video.__hitTestMask","openfl/media/Video.hx",418,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_433_get_height,"openfl.media.Video","get_height",0x7919c8cb,"openfl.media.Video.get_height","openfl/media/Video.hx",433,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_437_set_height,"openfl.media.Video","set_height",0x7c97673f,"openfl.media.Video.set_height","openfl/media/Video.hx",437,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_457_get_videoHeight,"openfl.media.Video","get_videoHeight",0xebac235e,"openfl.media.Video.get_videoHeight","openfl/media/Video.hx",457,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_469_get_videoWidth,"openfl.media.Video","get_videoWidth",0x3e3af66f,"openfl.media.Video.get_videoWidth","openfl/media/Video.hx",469,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_474_get_width,"openfl.media.Video","get_width",0x00df9da2,"openfl.media.Video.get_width","openfl/media/Video.hx",474,0x054fa1ed)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6bc49fba42380b_478_set_width,"openfl.media.Video","set_width",0xe43089ae,"openfl.media.Video.set_width","openfl/media/Video.hx",478,0x054fa1ed)
...
HXLINE( 210)		this->_hx___type = ::openfl::_internal::renderer::DisplayObjectType_obj::VIDEO_dyn();
HXLINE( 212)		this->_hx___width = ( (Float)(width) );
HXLINE( 213)		this->_hx___height = ( (Float)(height) );
HXLINE( 215)		this->_hx___textureTime = ( (Float)(-1) );
HXLINE( 217)		this->smoothing = false;
HXLINE( 218)		this->deblocking = 0;
            	}
...
void Video_obj::attachNetStream( ::openfl::net::NetStream netStream){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_255_attachNetStream)
HXDLIN( 255)		this->_hx___stream = netStream;
            	}
...
void Video_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_272_clear)
            	}
...
void Video_obj::_hx___enterFrame(int deltaTime){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_275___enterFrame)
            	}


void Video_obj::_hx___getBounds( ::openfl::geom::Rectangle rect, ::openfl::geom::Matrix matrix){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_285___getBounds)
HXLINE( 286)		 ::openfl::geom::Rectangle bounds = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 287)		bounds->setTo(( (Float)(0) ),( (Float)(0) ),this->_hx___width,this->_hx___height);
HXLINE( 288)		bounds->_hx___transform(bounds,matrix);
HXLINE( 290)		rect->_hx___expand(bounds->x,bounds->y,bounds->width,bounds->height);
HXLINE( 292)		::openfl::geom::Rectangle_obj::_hx___pool->release(bounds);
            	}


 ::openfl::display3D::IndexBuffer3D Video_obj::_hx___getIndexBuffer( ::openfl::display3D::Context3D context){
            	HX_GC_STACKFRAME(&_hx_pos_cb6bc49fba42380b_296___getIndexBuffer)
...
HXLINE( 316)		return this->_hx___indexBuffer;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Video_obj,_hx___getIndexBuffer,return )
 ...
 ::openfl::display3D::textures::RectangleTexture Video_obj::_hx___getTexture( ::openfl::display3D::Context3D context){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_343___getTexture)
...
HX_DEFINE_DYNAMIC_FUNC1(Video_obj,_hx___getTexture,return )
 ...
 ::openfl::display3D::VertexBuffer3D Video_obj::_hx___getVertexBuffer( ::openfl::display3D::Context3D context){
            	HX_GC_STACKFRAME(&_hx_pos_cb6bc49fba42380b_348___getVertexBuffer)
HXLINE( 349)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = context->gl;
HXLINE( 351)		bool _hx_tmp;
HXDLIN( 351)		if (hx::IsNotNull( this->_hx___vertexBuffer )) {
HXLINE( 351)			_hx_tmp = hx::IsNotEq( this->_hx___vertexBufferContext,context->_hx___context );
            		}
            		else {
HXLINE( 351)			_hx_tmp = true;
            		}
HXDLIN( 351)		if (_hx_tmp) {
HXLINE( 370)			int uvWidth = 1;
HXLINE( 371)			int uvHeight = 1;
HXLINE( 374)			 ::haxe::io::Bytes buffer = null();
HXDLIN( 374)			::cpp::VirtualArray array = null();
HXDLIN( 374)			 ::openfl::_Vector::FloatVector vector = null();
HXDLIN( 374)			 ::lime::utils::ArrayBufferView view = null();
HXDLIN( 374)			 ::Dynamic len = null();
HXDLIN( 374)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,20,8);
HXDLIN( 374)			this->_hx___vertexBufferData = this1;
HXLINE( 376)			{
HXLINE( 376)				 ::lime::utils::ArrayBufferView this2 = this->_hx___vertexBufferData;
HXDLIN( 376)				Float val = this->get_width();
HXDLIN( 376)				 ::__hxcpp_memory_set_float(this2->buffer->b,this2->byteOffset,val);
            			}
HXLINE( 377)			{
HXLINE( 377)				 ::lime::utils::ArrayBufferView this3 = this->_hx___vertexBufferData;
HXDLIN( 377)				Float val1 = this->get_height();
HXDLIN( 377)				 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 4),val1);
            			}
HXLINE( 378)			{
HXLINE( 378)				 ::lime::utils::ArrayBufferView this4 = this->_hx___vertexBufferData;
HXDLIN( 378)				 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 12),uvWidth);
            			}
HXLINE( 379)			{
HXLINE( 379)				 ::lime::utils::ArrayBufferView this5 = this->_hx___vertexBufferData;
HXDLIN( 379)				 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 16),uvHeight);
            			}
HXLINE( 380)			{
HXLINE( 380)				 ::lime::utils::ArrayBufferView this6 = this->_hx___vertexBufferData;
HXDLIN( 380)				Float val2 = this->get_height();
HXDLIN( 380)				 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 24),val2);
            			}
HXLINE( 381)			{
HXLINE( 381)				 ::lime::utils::ArrayBufferView this7 = this->_hx___vertexBufferData;
HXDLIN( 381)				 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 36),uvHeight);
            			}
HXLINE( 382)			{
HXLINE( 382)				 ::lime::utils::ArrayBufferView this8 = this->_hx___vertexBufferData;
HXDLIN( 382)				Float val3 = this->get_width();
HXDLIN( 382)				 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 40),val3);
            			}
HXLINE( 383)			{
HXLINE( 383)				 ::lime::utils::ArrayBufferView this9 = this->_hx___vertexBufferData;
HXDLIN( 383)				 ::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + 52),uvWidth);
            			}
HXLINE( 385)			this->_hx___vertexBufferContext = context->_hx___context;
HXLINE( 386)			this->_hx___vertexBuffer = context->createVertexBuffer(3,5,null());
HXLINE( 387)			this->_hx___vertexBuffer->uploadFromTypedArray(this->_hx___vertexBufferData,null());
            		}
HXLINE( 390)		return this->_hx___vertexBuffer;
            	}
...
bool Video_obj::_hx___hitTest(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_395___hitTest)
HXLINE( 396)		bool _hx_tmp;
HXDLIN( 396)		if (!(!(hitObject->get_visible()))) {
HXLINE( 396)			_hx_tmp = this->_hx___isMask;
            		}
            		else {
...
HXDLIN( 397)		if (hx::IsNotNull( this->get_mask() )) {
HXLINE( 397)			_hx_tmp1 = !(this->get_mask()->_hx___hitTestMask(x,y));
            		}
            		else {
...
HXLINE( 399)		this->_hx___getRenderTransform();
HXLINE( 401)		 ::openfl::geom::Matrix _this = this->_hx___renderTransform;
HXDLIN( 401)		Float norm = ((_this->a * _this->d) - (_this->b * _this->c));
HXDLIN( 401)		Float px;
HXDLIN( 401)		if ((norm == 0)) {
HXLINE( 401)			px = -(_this->tx);
            		}
            		else {
HXLINE( 401)			px = ((((Float)1.0) / norm) * ((_this->c * (_this->ty - y)) + (_this->d * (x - _this->tx))));
            		}
HXLINE( 402)		 ::openfl::geom::Matrix _this1 = this->_hx___renderTransform;
HXDLIN( 402)		Float norm1 = ((_this1->a * _this1->d) - (_this1->b * _this1->c));
HXDLIN( 402)		Float py;
HXDLIN( 402)		if ((norm1 == 0)) {
HXLINE( 402)			py = -(_this1->ty);
            		}
            		else {
HXLINE( 402)			py = ((((Float)1.0) / norm1) * ((_this1->a * (y - _this1->ty)) + (_this1->b * (_this1->tx - x))));
            		}
HXLINE( 404)		bool _hx_tmp2;
HXDLIN( 404)		bool _hx_tmp3;
HXDLIN( 404)		bool _hx_tmp4;
HXDLIN( 404)		if ((px > 0)) {
HXLINE( 404)			_hx_tmp4 = (py > 0);
            		}
            		else {
HXLINE( 404)			_hx_tmp4 = false;
            		}
HXDLIN( 404)		if (_hx_tmp4) {
HXLINE( 404)			_hx_tmp3 = (px <= this->_hx___width);
            		}
            		else {
HXLINE( 404)			_hx_tmp3 = false;
            		}
HXDLIN( 404)		if (_hx_tmp3) {
HXLINE( 404)			_hx_tmp2 = (py <= this->_hx___height);
            		}
            		else {
HXLINE( 404)			_hx_tmp2 = false;
            		}
HXDLIN( 404)		if (_hx_tmp2) {
HXLINE( 406)			bool _hx_tmp5;
HXDLIN( 406)			if (hx::IsNotNull( stack )) {
HXLINE( 406)				_hx_tmp5 = !(interactiveOnly);
            			}
            			else {
HXLINE( 406)				_hx_tmp5 = false;
            			}
HXDLIN( 406)			if (_hx_tmp5) {
HXLINE( 408)				stack->push(hitObject);
            			}
...
bool Video_obj::_hx___hitTestMask(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_418___hitTestMask)
HXLINE( 419)		 ::openfl::geom::Point point = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
HXLINE( 420)		point->setTo(x,y);
HXLINE( 422)		this->_hx___globalToLocal(point,point);
HXLINE( 424)		bool hit;
HXDLIN( 424)		bool hit1;
HXDLIN( 424)		bool hit2;
HXDLIN( 424)		if ((point->x > 0)) {
HXLINE( 424)			hit2 = (point->y > 0);
            		}
            		else {
HXLINE( 424)			hit2 = false;
            		}
HXDLIN( 424)		if (hit2) {
HXLINE( 424)			hit1 = (point->x <= this->_hx___width);
            		}
            		else {
HXLINE( 424)			hit1 = false;
            		}
HXDLIN( 424)		if (hit1) {
HXLINE( 424)			hit = (point->y <= this->_hx___height);
            		}
            		else {
HXLINE( 424)			hit = false;
            		}
HXLINE( 426)		::openfl::geom::Point_obj::_hx___pool->release(point);
HXLINE( 427)		return hit;
            	}


Float Video_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_433_get_height)
HXDLIN( 433)		Float _hx_tmp = this->_hx___height;
HXDLIN( 433)		return (_hx_tmp * this->get_scaleY());
            	}


Float Video_obj::set_height(Float value){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_437_set_height)
HXLINE( 438)		bool _hx_tmp;
HXDLIN( 438)		if ((this->get_scaleY() == 1)) {
HXLINE( 438)			_hx_tmp = (value != this->_hx___height);
            		}
            		else {
HXLINE( 438)			_hx_tmp = true;
            		}
HXDLIN( 438)		if (_hx_tmp) {
HXLINE( 440)			this->_hx___setTransformDirty();
HXLINE( 441)			this->_hx___dirty = true;
            		}
HXLINE( 444)		this->set_scaleY(( (Float)(1) ));
HXLINE( 445)		return (this->_hx___height = value);
            	}


int Video_obj::get_videoHeight(){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_457_get_videoHeight)
HXDLIN( 457)		return 0;
            	}
...
int Video_obj::get_videoWidth(){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_469_get_videoWidth)
HXDLIN( 469)		return 0;
            	}
...
Float Video_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_474_get_width)
HXDLIN( 474)		return (this->_hx___width * this->_hx___scaleX);
            	}


Float Video_obj::set_width(Float value){
            	HX_STACKFRAME(&_hx_pos_cb6bc49fba42380b_478_set_width)
HXLINE( 479)		bool _hx_tmp;
HXDLIN( 479)		if ((this->_hx___scaleX == 1)) {
HXLINE( 479)			_hx_tmp = (this->_hx___width != value);
            		}
            		else {
HXLINE( 479)			_hx_tmp = true;
            		}
HXDLIN( 479)		if (_hx_tmp) {
HXLINE( 481)			this->_hx___setTransformDirty();
HXLINE( 482)			this->_hx___dirty = true;
            		}
HXLINE( 485)		this->set_scaleX(( (Float)(1) ));
HXLINE( 486)		return (this->_hx___width = value);
            	}
