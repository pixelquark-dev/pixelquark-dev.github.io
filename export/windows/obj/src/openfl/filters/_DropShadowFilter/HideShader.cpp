...
HX_DEFINE_STACK_FRAME(_hx_pos_07af302b8e600910_574_new,"openfl.filters._DropShadowFilter.HideShader","new",0x8120a732,"openfl.filters._DropShadowFilter.HideShader.new","openfl/filters/DropShadowFilter.hx",574,0x048fdea4)
static const Float _hx_array_data_2554e640_1[] = {
	(Float)1,
};
static const Float _hx_array_data_2554e640_2[] = {
	(Float)0,(Float)0,
};
namespace openfl{
namespace filters{
...
void HideShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_07af302b8e600910_574_new)
...
HXLINE( 575)		super::__construct(null());
HXLINE( 577)		this->strength->value = ::Array_obj< Float >::fromData( _hx_array_data_2554e640_1,1);
HXLINE( 578)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_2554e640_2,2);
HXLINE( 547)		this->_hx___isGenerated = true;
HXDLIN( 547)		this->_hx___initGL();
            	}
...
bool HideShader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x676ab1f7) {
		...
		return inClassId==(int)0x7ad0fb26;
	}
}
...
static hx::StorageInfo HideShader_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*  ::openfl::display::ShaderParameter_Float */ ,(int)offsetof(HideShader_obj,strength),HX_("strength",81,d2,8e,8e)},
	{ hx::fsUnknown, 0, null()}
};
