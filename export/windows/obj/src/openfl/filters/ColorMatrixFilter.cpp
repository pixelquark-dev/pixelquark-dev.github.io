...
HXLINE( 208)										 ::lime::utils::ArrayBufferView this4 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___alpha16;
HXDLIN( 208)										::lime::math::_RGBA::RGBA_Impl__obj::a16 = ( (int)( ::__hxcpp_memory_get_ui32(this4->buffer->b,(this4->byteOffset + ((destPixel & 255) * 4)))) );
...
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val3);
            								...
            								case (int)1: {
HXLINE( 208)									{
HXLINE( 208)										int val4 = (destPixel & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val4);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val5 = (hx::UShr(destPixel,24) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),val5);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val6 = (hx::UShr(destPixel,16) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val6);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val7 = (hx::UShr(destPixel,8) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val7);
            									}
            								}
            								break;
            								case (int)2: {
HXLINE( 208)									{
HXLINE( 208)										int val8 = (hx::UShr(destPixel,8) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val8);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val9 = (hx::UShr(destPixel,16) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),val9);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val10 = (hx::UShr(destPixel,24) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val10);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val11 = (destPixel & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val11);
            									}
            								}
            								break;
            							}
