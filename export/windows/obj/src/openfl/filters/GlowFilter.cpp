...
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_271___initShader,"openfl.filters.GlowFilter","__initShader",0x188dd8ad,"openfl.filters.GlowFilter.__initShader","openfl/filters/GlowFilter.hx",271,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_337___updateSize,"openfl.filters.GlowFilter","__updateSize",0xfc3049c2,"openfl.filters.GlowFilter.__updateSize","openfl/filters/GlowFilter.hx",337,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_346___calculateNumShaderPasses,"openfl.filters.GlowFilter","__calculateNumShaderPasses",0xc270897c,"openfl.filters.GlowFilter.__calculateNumShaderPasses","openfl/filters/GlowFilter.hx",346,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_355_get_alpha,"openfl.filters.GlowFilter","get_alpha",0x780a0d7d,"openfl.filters.GlowFilter.get_alpha","openfl/filters/GlowFilter.hx",355,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_359_set_alpha,"openfl.filters.GlowFilter","set_alpha",0x5b5af989,"openfl.filters.GlowFilter.set_alpha","openfl/filters/GlowFilter.hx",359,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_366_get_blurX,"openfl.filters.GlowFilter","get_blurX",0x0b7475f0,"openfl.filters.GlowFilter.get_blurX","openfl/filters/GlowFilter.hx",366,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_370_set_blurX,"openfl.filters.GlowFilter","set_blurX",0xeec561fc,"openfl.filters.GlowFilter.set_blurX","openfl/filters/GlowFilter.hx",370,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_382_get_blurY,"openfl.filters.GlowFilter","get_blurY",0x0b7475f1,"openfl.filters.GlowFilter.get_blurY","openfl/filters/GlowFilter.hx",382,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_386_set_blurY,"openfl.filters.GlowFilter","set_blurY",0xeec561fd,"openfl.filters.GlowFilter.set_blurY","openfl/filters/GlowFilter.hx",386,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_398_get_color,"openfl.filters.GlowFilter","get_color",0xa0cfd782,"openfl.filters.GlowFilter.get_color","openfl/filters/GlowFilter.hx",398,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_402_set_color,"openfl.filters.GlowFilter","set_color",0x8420c38e,"openfl.filters.GlowFilter.set_color","openfl/filters/GlowFilter.hx",402,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_409_get_inner,"openfl.filters.GlowFilter","get_inner",0x148f97b5,"openfl.filters.GlowFilter.get_inner","openfl/filters/GlowFilter.hx",409,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_413_set_inner,"openfl.filters.GlowFilter","set_inner",0xf7e083c1,"openfl.filters.GlowFilter.set_inner","openfl/filters/GlowFilter.hx",413,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_424_get_knockout,"openfl.filters.GlowFilter","get_knockout",0xe353a13b,"openfl.filters.GlowFilter.get_knockout","openfl/filters/GlowFilter.hx",424,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_428_set_knockout,"openfl.filters.GlowFilter","set_knockout",0xf84cc4af,"openfl.filters.GlowFilter.set_knockout","openfl/filters/GlowFilter.hx",428,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_439_get_quality,"openfl.filters.GlowFilter","get_quality",0xaafc709e,"openfl.filters.GlowFilter.get_quality","openfl/filters/GlowFilter.hx",439,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_443_set_quality,"openfl.filters.GlowFilter","set_quality",0xb56977aa,"openfl.filters.GlowFilter.set_quality","openfl/filters/GlowFilter.hx",443,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_454_get_strength,"openfl.filters.GlowFilter","get_strength",0x023cc9c2,"openfl.filters.GlowFilter.get_strength","openfl/filters/GlowFilter.hx",454,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_458_set_strength,"openfl.filters.GlowFilter","set_strength",0x1735ed36,"openfl.filters.GlowFilter.set_strength","openfl/filters/GlowFilter.hx",458,0x5f568606)
...
HXDLIN( 252)		if (!(this->_hx___inner)) {
HXLINE( 252)			_hx_tmp = this->_hx___knockout;
            		}
            		else {
HXLINE( 252)			_hx_tmp = true;
            		}
HXDLIN( 252)		if (_hx_tmp) {
HXLINE( 254)			 ::lime::graphics::Image sourceBitmapData1 = sourceBitmapData->image;
HXDLIN( 254)			 ::lime::math::Rectangle _hx_tmp1 = sourceBitmapData->image->get_rect();
HXDLIN( 254)			sourceBitmapData1->colorTransform(_hx_tmp1, ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,1,1,1,0,0,0,0,-255)->_hx___toLimeColorMatrix());
HXLINE( 255)			sourceBitmapData->image->dirty = true;
HXLINE( 256)			sourceBitmapData->image->version++;
HXLINE( 257)			bitmapData = sourceBitmapData->clone();
HXLINE( 258)			return bitmapData;
            		}
HXLINE( 261)		 ::lime::graphics::Image bitmapData1 = bitmapData->image;
HXDLIN( 261)		 ::lime::graphics::Image sourceBitmapData2 = sourceBitmapData->image;
HXDLIN( 261)		 ::lime::math::Rectangle finalImage = sourceRect->_hx___toLimeRectangle();
HXDLIN( 261)		 ::lime::math::Vector2 finalImage1 = destPoint->_hx___toLimeVector2();
HXDLIN( 261)		 ::lime::graphics::Image finalImage2 = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData2,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,this->_hx___strength,null());
HXLINE( 263)		 ::lime::math::Rectangle _hx_tmp2 = finalImage2->get_rect();
HXDLIN( 263)		finalImage2->colorTransform(_hx_tmp2, ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,0,0,0,this->_hx___alpha,r,g,b,0)->_hx___toLimeColorMatrix());
HXLINE( 265)		if (hx::IsEq( finalImage2,bitmapData->image )) {
HXLINE( 265)			return bitmapData;
            		}
HXLINE( 267)		return sourceBitmapData;
            	}
 ...
 ::openfl::display::Shader GlowFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_271___initShader)
HXLINE( 274)		bool _hx_tmp;
HXDLIN( 274)		if (this->_hx___inner) {
HXLINE( 274)			_hx_tmp = (pass == 0);
            		}
            		else {
HXLINE( 274)			_hx_tmp = false;
            		}
HXDLIN( 274)		if (_hx_tmp) {
HXLINE( 276)			return ::openfl::filters::GlowFilter_obj::_hx___invertAlphaShader;
            		}
HXLINE( 279)		int blurPass;
HXDLIN( 279)		if (this->_hx___inner) {
HXLINE( 279)			blurPass = 1;
            		}
            		else {
HXLINE( 279)			blurPass = 0;
            		}
HXDLIN( 279)		int blurPass1 = (pass - blurPass);
HXLINE( 280)		int numBlurPasses = (this->_hx___horizontalPasses + this->_hx___verticalPasses);
HXLINE( 282)		if ((blurPass1 < numBlurPasses)) {
HXLINE( 284)			 ::openfl::filters::_GlowFilter::BlurAlphaShader shader = ::openfl::filters::GlowFilter_obj::_hx___blurAlphaShader;
HXLINE( 285)			if ((blurPass1 < this->_hx___horizontalPasses)) {
HXLINE( 287)				Float scale = ::Math_obj::pow(((Float)0.5),( (Float)((blurPass1 >> 1)) ));
HXLINE( 288)				shader->uRadius->value[0] = (this->get_blurX() * scale);
HXLINE( 289)				shader->uRadius->value[1] = ( (Float)(0) );
            			}
            			else {
HXLINE( 293)				Float scale1 = ::Math_obj::pow(((Float)0.5),( (Float)(((blurPass1 - this->_hx___horizontalPasses) >> 1)) ));
HXLINE( 294)				shader->uRadius->value[0] = ( (Float)(0) );
HXLINE( 295)				shader->uRadius->value[1] = (this->get_blurY() * scale1);
            			}
HXLINE( 297)			shader->uColor->value[0] = (( (Float)(((this->get_color() >> 16) & 255)) ) / ( (Float)(255) ));
HXLINE( 298)			shader->uColor->value[1] = (( (Float)(((this->get_color() >> 8) & 255)) ) / ( (Float)(255) ));
HXLINE( 299)			shader->uColor->value[2] = (( (Float)((this->get_color() & 255)) ) / ( (Float)(255) ));
HXLINE( 300)			shader->uColor->value[3] = this->get_alpha();
HXLINE( 301)			return shader;
            		}
HXLINE( 303)		if (this->_hx___inner) {
HXLINE( 305)			if (this->_hx___knockout) {
HXLINE( 307)				 ::openfl::filters::_GlowFilter::InnerCombineKnockoutShader shader1 = ::openfl::filters::GlowFilter_obj::_hx___innerCombineKnockoutShader;
HXLINE( 308)				shader1->sourceBitmap->input = sourceBitmapData;
HXLINE( 309)				shader1->strength->value[0] = this->_hx___strength;
HXLINE( 310)				return shader1;
            			}
HXLINE( 312)			 ::openfl::filters::_GlowFilter::InnerCombineShader shader2 = ::openfl::filters::GlowFilter_obj::_hx___innerCombineShader;
HXLINE( 313)			shader2->sourceBitmap->input = sourceBitmapData;
HXLINE( 314)			shader2->strength->value[0] = this->_hx___strength;
HXLINE( 315)			return shader2;
            		}
            		else {
HXLINE( 319)			if (this->_hx___knockout) {
HXLINE( 321)				 ::openfl::filters::_GlowFilter::CombineKnockoutShader shader3 = ::openfl::filters::GlowFilter_obj::_hx___combineKnockoutShader;
HXLINE( 322)				shader3->sourceBitmap->input = sourceBitmapData;
HXLINE( 323)				shader3->strength->value[0] = this->_hx___strength;
HXLINE( 324)				return shader3;
            			}
HXLINE( 326)			 ::openfl::filters::_GlowFilter::CombineShader shader4 = ::openfl::filters::GlowFilter_obj::_hx___combineShader;
HXLINE( 327)			shader4->sourceBitmap->input = sourceBitmapData;
HXLINE( 328)			shader4->strength->value[0] = this->_hx___strength;
HXLINE( 329)			return shader4;
            		}
...
void GlowFilter_obj::_hx___updateSize(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_337___updateSize)
HXLINE( 338)		int _hx_tmp;
HXDLIN( 338)		if ((this->_hx___blurX > 0)) {
HXLINE( 338)			_hx_tmp = ::Math_obj::ceil((this->_hx___blurX * ((Float)1.5)));
            		}
            		else {
HXLINE( 338)			_hx_tmp = 0;
            		}
HXDLIN( 338)		this->_hx___leftExtension = _hx_tmp;
HXLINE( 339)		this->_hx___rightExtension = this->_hx___leftExtension;
HXLINE( 340)		int _hx_tmp1;
HXDLIN( 340)		if ((this->_hx___blurY > 0)) {
HXLINE( 340)			_hx_tmp1 = ::Math_obj::ceil((this->_hx___blurY * ((Float)1.5)));
            		}
            		else {
HXLINE( 340)			_hx_tmp1 = 0;
            		}
HXDLIN( 340)		this->_hx___topExtension = _hx_tmp1;
HXLINE( 341)		this->_hx___bottomExtension = this->_hx___topExtension;
HXLINE( 342)		this->_hx___calculateNumShaderPasses();
            	}
...
void GlowFilter_obj::_hx___calculateNumShaderPasses(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_346___calculateNumShaderPasses)
HXLINE( 347)		int _hx_tmp;
HXDLIN( 347)		if ((this->_hx___blurX <= 0)) {
HXLINE( 347)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 347)			_hx_tmp = (::Math_obj::round((this->_hx___blurX * (( (Float)(this->_hx___quality) ) / ( (Float)(4) )))) + 1);
            		}
HXDLIN( 347)		this->_hx___horizontalPasses = _hx_tmp;
HXLINE( 348)		int _hx_tmp1;
HXDLIN( 348)		if ((this->_hx___blurY <= 0)) {
HXLINE( 348)			_hx_tmp1 = 0;
            		}
            		else {
HXLINE( 348)			_hx_tmp1 = (::Math_obj::round((this->_hx___blurY * (( (Float)(this->_hx___quality) ) / ( (Float)(4) )))) + 1);
            		}
HXDLIN( 348)		this->_hx___verticalPasses = _hx_tmp1;
HXLINE( 349)		int _hx_tmp2;
HXDLIN( 349)		if (this->_hx___inner) {
HXLINE( 349)			_hx_tmp2 = 2;
            		}
            		else {
HXLINE( 349)			_hx_tmp2 = 1;
            		}
HXDLIN( 349)		this->_hx___numShaderPasses = ((this->_hx___horizontalPasses + this->_hx___verticalPasses) + _hx_tmp2);
            	}
...
Float GlowFilter_obj::get_alpha(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_355_get_alpha)
HXDLIN( 355)		return this->_hx___alpha;
            	}
...
Float GlowFilter_obj::set_alpha(Float value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_359_set_alpha)
HXLINE( 360)		if ((value != this->_hx___alpha)) {
HXLINE( 360)			this->_hx___renderDirty = true;
            		}
HXLINE( 361)		return (this->_hx___alpha = value);
            	}
...
Float GlowFilter_obj::get_blurX(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_366_get_blurX)
HXDLIN( 366)		return this->_hx___blurX;
            	}
...
Float GlowFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_370_set_blurX)
HXLINE( 371)		if ((value != this->_hx___blurX)) {
HXLINE( 373)			this->_hx___blurX = value;
HXLINE( 374)			this->_hx___renderDirty = true;
HXLINE( 375)			this->_hx___updateSize();
            		}
...
Float GlowFilter_obj::get_blurY(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_382_get_blurY)
HXDLIN( 382)		return this->_hx___blurY;
            	}
...
Float GlowFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_386_set_blurY)
HXLINE( 387)		if ((value != this->_hx___blurY)) {
HXLINE( 389)			this->_hx___blurY = value;
HXLINE( 390)			this->_hx___renderDirty = true;
HXLINE( 391)			this->_hx___updateSize();
            		}
...
int GlowFilter_obj::get_color(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_398_get_color)
HXDLIN( 398)		return this->_hx___color;
            	}
...
int GlowFilter_obj::set_color(int value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_402_set_color)
HXLINE( 403)		if ((value != this->_hx___color)) {
HXLINE( 403)			this->_hx___renderDirty = true;
            		}
HXLINE( 404)		return (this->_hx___color = value);
            	}
...
bool GlowFilter_obj::get_inner(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_409_get_inner)
...
bool GlowFilter_obj::set_inner(bool value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_413_set_inner)
HXLINE( 414)		if ((value != this->_hx___inner)) {
HXLINE( 416)			this->_hx___renderDirty = true;
HXLINE( 417)			this->_hx___calculateNumShaderPasses();
            		}
HXLINE( 419)		return (this->_hx___inner = value);
            	}
...
bool GlowFilter_obj::get_knockout(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_424_get_knockout)
HXDLIN( 424)		return this->_hx___knockout;
            	}
...
bool GlowFilter_obj::set_knockout(bool value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_428_set_knockout)
HXLINE( 429)		if ((value != this->_hx___knockout)) {
HXLINE( 431)			this->_hx___renderDirty = true;
HXLINE( 432)			this->_hx___calculateNumShaderPasses();
            		}
HXLINE( 434)		return (this->_hx___knockout = value);
            	}
...
int GlowFilter_obj::get_quality(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_439_get_quality)
HXDLIN( 439)		return this->_hx___quality;
            	}
...
int GlowFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_443_set_quality)
HXLINE( 444)		if ((value != this->_hx___quality)) {
HXLINE( 446)			this->_hx___renderDirty = true;
HXLINE( 447)			this->_hx___calculateNumShaderPasses();
            		}
HXLINE( 449)		return (this->_hx___quality = value);
            	}
...
Float GlowFilter_obj::get_strength(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_454_get_strength)
HXDLIN( 454)		return this->_hx___strength;
            	}
...
Float GlowFilter_obj::set_strength(Float value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_458_set_strength)
HXLINE( 459)		if ((value != this->_hx___strength)) {
HXLINE( 459)			this->_hx___renderDirty = true;
            		}
HXLINE( 460)		return (this->_hx___strength = value);
            	}
