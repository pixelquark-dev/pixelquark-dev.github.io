...
HX_DEFINE_STACK_FRAME(_hx_pos_bfba60fe12c23493_599_new,"openfl.filters._GlowFilter.CombineShader","new",0x929ab2fb,"openfl.filters._GlowFilter.CombineShader.new","openfl/filters/GlowFilter.hx",599,0x5f568606)
static const Float _hx_array_data_1cf91989_1[] = {
	(Float)1,
};
static const Float _hx_array_data_1cf91989_2[] = {
	(Float)0,(Float)0,
};
namespace openfl{
namespace filters{
...
void CombineShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_bfba60fe12c23493_599_new)
...
HXLINE( 600)		super::__construct(null());
HXLINE( 602)		this->strength->value = ::Array_obj< Float >::fromData( _hx_array_data_1cf91989_1,1);
HXLINE( 603)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_1cf91989_2,2);
HXLINE( 571)		this->_hx___isGenerated = true;
HXDLIN( 571)		this->_hx___initGL();
            	}
...
static hx::StorageInfo CombineShader_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*  ::openfl::display::ShaderParameter_Float */ ,(int)offsetof(CombineShader_obj,strength),HX_("strength",81,d2,8e,8e)},
	{ hx::fsUnknown, 0, null()}
};
