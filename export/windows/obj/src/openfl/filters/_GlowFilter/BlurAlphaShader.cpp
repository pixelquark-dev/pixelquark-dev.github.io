...
HX_DEFINE_STACK_FRAME(_hx_pos_6216d328fc85d16b_558_new,"openfl.filters._GlowFilter.BlurAlphaShader","new",0x982180f3,"openfl.filters._GlowFilter.BlurAlphaShader.new","openfl/filters/GlowFilter.hx",558,0x5f568606)
...
void BlurAlphaShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6216d328fc85d16b_558_new)
...
HXLINE( 559)		super::__construct(null());
HXLINE( 561)		this->uRadius->value = ::Array_obj< Float >::fromData( _hx_array_data_3a938b81_1,2);
HXLINE( 562)		this->uColor->value = ::Array_obj< Float >::fromData( _hx_array_data_3a938b81_2,4);
HXLINE( 500)		this->_hx___isGenerated = true;
HXDLIN( 500)		this->_hx___initGL();
            	}
