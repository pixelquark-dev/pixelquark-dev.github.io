...
HX_DEFINE_STACK_FRAME(_hx_pos_9729ccfc0a6c6d24_491_new,"openfl.filters._GlowFilter.InvertAlphaShader","new",0xf5d98ca4,"openfl.filters._GlowFilter.InvertAlphaShader.new","openfl/filters/GlowFilter.hx",491,0x5f568606)
namespace openfl{
namespace filters{
namespace _GlowFilter{

void InvertAlphaShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_9729ccfc0a6c6d24_491_new)
...
HXLINE( 492)		super::__construct(null());
HXLINE( 468)		this->_hx___isGenerated = true;
HXDLIN( 468)		this->_hx___initGL();
            	}
...
bool InvertAlphaShader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x676ab1f7) {
		...
		return inClassId==(int)0x6aedba14;
	}
}
