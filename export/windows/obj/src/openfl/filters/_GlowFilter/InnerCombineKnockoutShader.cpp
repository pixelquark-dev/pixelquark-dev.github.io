...
HX_DEFINE_STACK_FRAME(_hx_pos_b4e7cc65cbc49df7_722_new,"openfl.filters._GlowFilter.InnerCombineKnockoutShader","new",0x68ce62f5,"openfl.filters._GlowFilter.InnerCombineKnockoutShader.new","openfl/filters/GlowFilter.hx",722,0x5f568606)
static const Float _hx_array_data_b9e2c483_1[] = {
	(Float)0,(Float)0,
};
static const Float _hx_array_data_b9e2c483_2[] = {
	(Float)1,
};
namespace openfl{
namespace filters{
...
void InnerCombineKnockoutShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b4e7cc65cbc49df7_722_new)
...
HXLINE( 723)		super::__construct(null());
HXLINE( 725)		this->offset->value = ::Array_obj< Float >::fromData( _hx_array_data_b9e2c483_1,2);
HXLINE( 726)		this->strength->value = ::Array_obj< Float >::fromData( _hx_array_data_b9e2c483_2,1);
HXLINE( 694)		this->_hx___isGenerated = true;
HXDLIN( 694)		this->_hx___initGL();
            	}
...
bool InnerCombineKnockoutShader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x676ab1f7) {
		...
		return inClassId==(int)0x68b9d545;
	}
}
...
static hx::StorageInfo InnerCombineKnockoutShader_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*  ::openfl::display::ShaderParameter_Float */ ,(int)offsetof(InnerCombineKnockoutShader_obj,strength),HX_("strength",81,d2,8e,8e)},
	{ hx::fsUnknown, 0, null()}
};
