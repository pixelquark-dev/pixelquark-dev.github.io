...
HX_LOCAL_STACK_FRAME(_hx_pos_6659164148434b5e_374___uploadFromImage,"openfl.display3D.textures.TextureBase","__uploadFromImage",0xeaecc031,"openfl.display3D.textures.TextureBase.__uploadFromImage","openfl/display3D/textures/TextureBase.hx",374,0x7b0f92ae)
...
HXLINE( 235)			{
HXLINE( 235)				 ::lime::graphics::opengl::GLObject renderbuffer = null();
HXDLIN( 235)				gl->bindRenderbuffer(gl->RENDERBUFFER,renderbuffer);
            			}
            		}
...
void TextureBase_obj::_hx___uploadFromImage( ::lime::graphics::Image image){
            	HX_STACKFRAME(&_hx_pos_6659164148434b5e_374___uploadFromImage)
HXLINE( 375)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE( 376)		int internalFormat;
HXDLIN( 376)		int format;
HXLINE( 378)		if ((this->_hx___textureTarget != gl->TEXTURE_2D)) {
HXLINE( 378)			return;
            		}
HXLINE( 380)		if ((image->buffer->bitsPerPixel == 1)) {
HXLINE( 382)			internalFormat = gl->ALPHA;
HXLINE( 383)			format = gl->ALPHA;
            		}
            		else {
HXLINE( 387)			internalFormat = ::openfl::display3D::textures::TextureBase_obj::_hx___textureInternalFormat;
HXLINE( 388)			format = ::openfl::display3D::textures::TextureBase_obj::_hx___textureFormat;
            		}
HXLINE( 391)		this->_hx___context->_hx___bindGLTexture2D(this->_hx___textureID);
HXLINE( 415)		{
HXLINE( 415)			int target = gl->TEXTURE_2D;
HXDLIN( 415)			int width = image->buffer->width;
HXDLIN( 415)			int height = image->buffer->height;
HXDLIN( 415)			int type = gl->UNSIGNED_BYTE;
HXDLIN( 415)			 ::lime::utils::ArrayBufferView srcData = image->get_data();
HXDLIN( 415)			{
HXLINE( 415)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),srcData,null(),0);
HXDLIN( 415)				gl->texImage2D(target,0,internalFormat,width,height,0,format,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            			}
            		}
HXLINE( 418)		this->_hx___context->_hx___bindGLTexture2D(null());
            	}
