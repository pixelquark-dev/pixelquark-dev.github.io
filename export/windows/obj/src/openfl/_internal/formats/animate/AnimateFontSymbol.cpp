...
HX_DEFINE_STACK_FRAME(_hx_pos_d349685e4c098a54_23_new,"openfl._internal.formats.animate.AnimateFontSymbol","new",0x2d2ee30b,"openfl._internal.formats.animate.AnimateFontSymbol.new","openfl/_internal/formats/animate/AnimateFontSymbol.hx",23,0xb7b0b909)
namespace openfl{
namespace _internal{
namespace formats{
namespace animate{
...
void AnimateFontSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_d349685e4c098a54_23_new)
...
bool AnimateFontSymbol_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x12e3f49b) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x12e3f49b;
	} else {
		return inClassId==(int)0x2206ca08;
	}
}
...
hx::ObjectPtr< AnimateFontSymbol_obj > AnimateFontSymbol_obj::__alloc(hx::Ctx *_hx_ctx) {
	AnimateFontSymbol_obj *__this = (AnimateFontSymbol_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(AnimateFontSymbol_obj), true, "openfl._internal.formats.animate.AnimateFontSymbol"));
...
void AnimateFontSymbol_obj::__register()
{
	...
	__mClass->mName = HX_("openfl._internal.formats.animate.AnimateFontSymbol",99,01,90,87);
