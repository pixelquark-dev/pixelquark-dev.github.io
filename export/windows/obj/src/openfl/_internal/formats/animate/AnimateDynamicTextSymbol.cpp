...
HX_DEFINE_STACK_FRAME(_hx_pos_e13f6f6678fa115c_44_new,"openfl._internal.formats.animate.AnimateDynamicTextSymbol","new",0xf0b2b564,"openfl._internal.formats.animate.AnimateDynamicTextSymbol.new","openfl/_internal/formats/animate/AnimateDynamicTextSymbol.hx",44,0x505f60c8)
HX_LOCAL_STACK_FRAME(_hx_pos_e13f6f6678fa115c_48___createObject,"openfl._internal.formats.animate.AnimateDynamicTextSymbol","__createObject",0xecc43377,"openfl._internal.formats.animate.AnimateDynamicTextSymbol.__createObject","openfl/_internal/formats/animate/AnimateDynamicTextSymbol.hx",48,0x505f60c8)
namespace openfl{
namespace _internal{
namespace formats{
namespace animate{
...
void AnimateDynamicTextSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e13f6f6678fa115c_44_new)
...
bool AnimateDynamicTextSymbol_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2206ca08) {
		...
		return inClassId==(int)0x3dd8c4b0;
	}
}

 ::openfl::display::DisplayObject AnimateDynamicTextSymbol_obj::_hx___createObject( ::openfl::_internal::formats::animate::AnimateLibrary library){
            	HX_GC_STACKFRAME(&_hx_pos_e13f6f6678fa115c_48___createObject)
...
HXLINE(  84)		 ::openfl::_internal::formats::animate::AnimateFontSymbol font = ( ( ::openfl::_internal::formats::animate::AnimateFontSymbol)(library->symbols->get(this->fontID)) );
...
HXLINE( 145)				::lime::utils::Log_obj::warn(((HX_("Could not find required font \"",97,15,e8,5b) + format->font) + HX_("\", it has not been embedded",4c,66,7a,0a)),hx::SourceInfo(HX_("openfl/_internal/formats/animate/AnimateDynamicTextSymbol.hx",c8,60,5f,50),145,HX_("openfl._internal.formats.animate.AnimateDynamicTextSymbol",72,73,13,14),HX_("__createObject",fb,41,55,58)));
            			}
            		}
...
hx::ObjectPtr< AnimateDynamicTextSymbol_obj > AnimateDynamicTextSymbol_obj::__alloc(hx::Ctx *_hx_ctx) {
	AnimateDynamicTextSymbol_obj *__this = (AnimateDynamicTextSymbol_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(AnimateDynamicTextSymbol_obj), true, "openfl._internal.formats.animate.AnimateDynamicTextSymbol"));
...
void AnimateDynamicTextSymbol_obj::__register()
{
	...
	__mClass->mName = HX_("openfl._internal.formats.animate.AnimateDynamicTextSymbol",72,73,13,14);
