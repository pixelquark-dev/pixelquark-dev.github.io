...
HX_DEFINE_STACK_FRAME(_hx_pos_bf8831747d9e8afa_878_new,"openfl._internal.formats.animate._AnimateTimeline.FrameSymbolInstance","new",0x36a56e10,"openfl._internal.formats.animate._AnimateTimeline.FrameSymbolInstance.new","openfl/_internal/formats/animate/AnimateTimeline.hx",878,0x81d368cf)
namespace openfl{
namespace _internal{
namespace formats{
namespace animate{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_bf8831747d9e8afa_878_new)
HXLINE( 879)		this->initFrame = initFrame;
HXLINE( 880)		this->initFrameObjectID = initFrameObjectID;
HXLINE( 881)		this->characterID = characterID;
HXLINE( 882)		this->depth = depth;
HXLINE( 883)		this->displayObject = displayObject;
HXLINE( 884)		this->clipDepth = clipDepth;
            	}
...
bool FrameSymbolInstance_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0be44606;
}
...
hx::ObjectPtr< FrameSymbolInstance_obj > FrameSymbolInstance_obj::__alloc(hx::Ctx *_hx_ctx,int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth) {
	FrameSymbolInstance_obj *__this = (FrameSymbolInstance_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(FrameSymbolInstance_obj), true, "openfl._internal.formats.animate._AnimateTimeline.FrameSymbolInstance"));
...
void FrameSymbolInstance_obj::__register()
{
	...
	__mClass->mName = HX_("openfl._internal.formats.animate._AnimateTimeline.FrameSymbolInstance",1e,66,39,e2);
