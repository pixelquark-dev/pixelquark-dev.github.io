...
HX_LOCAL_STACK_FRAME(_hx_pos_95420d7511b8e364_17_render,"openfl._internal.renderer.context3D.Context3DTextField","render",0x823c412e,"openfl._internal.renderer.context3D.Context3DTextField.render","openfl/_internal/renderer/context3D/Context3DTextField.hx",17,0x12c70ba8)
HX_LOCAL_STACK_FRAME(_hx_pos_95420d7511b8e364_27_renderMask,"openfl._internal.renderer.context3D.Context3DTextField","renderMask",0x0b8edd3a,"openfl._internal.renderer.context3D.Context3DTextField.renderMask","openfl/_internal/renderer/context3D/Context3DTextField.hx",27,0x12c70ba8)
HX_LOCAL_STACK_FRAME(_hx_pos_95420d7511b8e364_14_boot,"openfl._internal.renderer.context3D.Context3DTextField","boot",0x6ea0b40a,"openfl._internal.renderer.context3D.Context3DTextField.boot","openfl/_internal/renderer/context3D/Context3DTextField.hx",14,0x12c70ba8)
namespace openfl{
namespace _internal{
namespace renderer{
namespace context3D{
...
void Context3DTextField_obj::render( ::openfl::text::TextField textField, ::openfl::_internal::renderer::context3D::Context3DRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_95420d7511b8e364_17_render)
HXLINE(  21)		::openfl::_internal::renderer::cairo::CairoTextField_obj::render(textField,( ( ::openfl::_internal::renderer::cairo::CairoRenderer)(renderer->_hx___softwareRenderer) ),textField->_hx___worldTransform);
HXLINE(  23)		textField->_hx___graphics->_hx___hardwareDirty = false;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(Context3DTextField_obj,render,(void))

void Context3DTextField_obj::renderMask( ::openfl::text::TextField textField, ::openfl::_internal::renderer::context3D::Context3DRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_95420d7511b8e364_27_renderMask)
HXLINE(  31)		::openfl::_internal::renderer::cairo::CairoTextField_obj::render(textField,( ( ::openfl::_internal::renderer::cairo::CairoRenderer)(renderer->_hx___softwareRenderer) ),textField->_hx___worldTransform);
HXLINE(  33)		textField->_hx___graphics->_hx___hardwareDirty = false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_95420d7511b8e364_14_boot)
