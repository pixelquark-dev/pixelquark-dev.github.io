...
HX_LOCAL_STACK_FRAME(_hx_pos_eb9e22bc341d245c_11_boot,"openfl._internal.renderer.canvas.CanvasDisplayObject","boot",0xaf423592,"openfl._internal.renderer.canvas.CanvasDisplayObject.boot","openfl/_internal/renderer/canvas/CanvasDisplayObject.hx",11,0x74b28f52)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
void CanvasDisplayObject_obj::render( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::canvas::CanvasRenderer renderer){
...
{
{
            	HX_STACKFRAME(&_hx_pos_eb9e22bc341d245c_11_boot)
