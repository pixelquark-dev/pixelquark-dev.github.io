...
HX_LOCAL_STACK_FRAME(_hx_pos_2b98ee52b048188b_14_render,"openfl._internal.renderer.canvas.CanvasBitmap","render",0x768a0e62,"openfl._internal.renderer.canvas.CanvasBitmap.render","openfl/_internal/renderer/canvas/CanvasBitmap.hx",14,0x093d64fa)
HX_LOCAL_STACK_FRAME(_hx_pos_2b98ee52b048188b_11_boot,"openfl._internal.renderer.canvas.CanvasBitmap","boot",0x08010c3e,"openfl._internal.renderer.canvas.CanvasBitmap.boot","openfl/_internal/renderer/canvas/CanvasBitmap.hx",11,0x093d64fa)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
void CanvasBitmap_obj::render( ::openfl::display::Bitmap bitmap, ::openfl::_internal::renderer::canvas::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_2b98ee52b048188b_14_render)
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_2b98ee52b048188b_11_boot)
