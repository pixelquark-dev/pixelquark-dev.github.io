...
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_185_get_positions,"openfl._internal.text.TextLayout","get_positions",0xe8c451db,"openfl._internal.text.TextLayout.get_positions","openfl/_internal/text/TextLayout.hx",185,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_197_get_direction,"openfl._internal.text.TextLayout","get_direction",0x28b2c070,"openfl._internal.text.TextLayout.get_direction","openfl/_internal/text/TextLayout.hx",197,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_201_set_direction,"openfl._internal.text.TextLayout","set_direction",0x6db8a27c,"openfl._internal.text.TextLayout.set_direction","openfl/_internal/text/TextLayout.hx",201,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_211_set_font,"openfl._internal.text.TextLayout","set_font",0x6d4a06b2,"openfl._internal.text.TextLayout.set_font","openfl/_internal/text/TextLayout.hx",211,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_222_get_glyphs,"openfl._internal.text.TextLayout","get_glyphs",0x88cb4276,"openfl._internal.text.TextLayout.get_glyphs","openfl/_internal/text/TextLayout.hx",222,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_235_get_language,"openfl._internal.text.TextLayout","get_language",0x8c8bb347,"openfl._internal.text.TextLayout.get_language","openfl/_internal/text/TextLayout.hx",235,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_239_set_language,"openfl._internal.text.TextLayout","set_language",0xa184d6bb,"openfl._internal.text.TextLayout.set_language","openfl/_internal/text/TextLayout.hx",239,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_250_get_script,"openfl._internal.text.TextLayout","get_script",0x21d2973a,"openfl._internal.text.TextLayout.get_script","openfl/_internal/text/TextLayout.hx",250,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_254_set_script,"openfl._internal.text.TextLayout","set_script",0x255035ae,"openfl._internal.text.TextLayout.set_script","openfl/_internal/text/TextLayout.hx",254,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_264_set_size,"openfl._internal.text.TextLayout","set_size",0x75dd49a4,"openfl._internal.text.TextLayout.set_size","openfl/_internal/text/TextLayout.hx",264,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_273_set_text,"openfl._internal.text.TextLayout","set_text",0x76837590,"openfl._internal.text.TextLayout.set_text","openfl/_internal/text/TextLayout.hx",273,0x21621597)
...
HXLINE( 144)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF8(this->_hx___hbBuffer,this->text,0,-1);
HXLINE( 150)			::lime::text::harfbuzz::HB_obj::shape(this->_hx___hbFont,this->_hx___hbBuffer,null());
HXLINE( 152)			::Array< ::Dynamic> _info = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphInfo(this->_hx___hbBuffer);
HXLINE( 153)			::Array< ::Dynamic> _positions = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphPositions(this->_hx___hbBuffer);
HXLINE( 155)			bool _hx_tmp3;
HXDLIN( 155)			if (hx::IsNotNull( _info )) {
HXLINE( 155)				_hx_tmp3 = hx::IsNotNull( _positions );
            			}
            			else {
HXLINE( 155)				_hx_tmp3 = false;
            			}
HXDLIN( 155)			if (_hx_tmp3) {
HXLINE( 157)				 ::lime::text::harfbuzz::HBGlyphInfo info;
HXDLIN( 157)				 ::lime::text::harfbuzz::HBGlyphPosition position;
HXLINE( 158)				int lastCluster = -1;
HXLINE( 160)				int length = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(_info->length) ),( (Float)(_positions->length) )));
HXLINE( 162)				{
HXLINE( 162)					int _g = 0;
HXDLIN( 162)					int _g1 = length;
...
HXLINE( 167)						{
HXLINE( 167)							int _g2 = (lastCluster + 1);
HXDLIN( 167)							int _g11 = info->cluster;
HXDLIN( 167)							while((_g2 < _g11)){
HXLINE( 167)								_g2 = (_g2 + 1);
HXDLIN( 167)								int j = (_g2 - 1);
HXLINE( 171)								::Array< ::Dynamic> _hx_tmp4 = this->get_positions();
HXDLIN( 171)								 ::lime::math::Vector2 _hx_tmp5 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 171)								_hx_tmp4->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp5, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 174)						::Array< ::Dynamic> _hx_tmp6 = this->get_positions();
HXDLIN( 174)						int info1 = info->codepoint;
HXDLIN( 174)						 ::lime::math::Vector2 _hx_tmp7 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 174)						_hx_tmp6->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp7, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
...
::Array< ::Dynamic> TextLayout_obj::get_positions(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_185_get_positions)
HXLINE( 186)		if (this->_hx___dirty) {
HXLINE( 188)			this->_hx___dirty = false;
HXLINE( 189)			this->_hx___position();
            		}
HXLINE( 192)		return this->positions;
            	}
...
int TextLayout_obj::get_direction(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_197_get_direction)
HXDLIN( 197)		return this->_hx___direction;
            	}
...
int TextLayout_obj::set_direction(int value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_201_set_direction)
HXLINE( 202)		if ((value == this->_hx___direction)) {
HXLINE( 202)			return value;
            		}
HXLINE( 204)		this->_hx___direction = value;
HXLINE( 205)		this->_hx___dirty = true;
...
HX_DEFINE_DYNAMIC_FUNC1(TextLayout_obj,set_direction,return )
 ...
 ::lime::text::Font TextLayout_obj::set_font( ::lime::text::Font value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_211_set_font)
HXLINE( 212)		if (hx::IsEq( value,this->font )) {
HXLINE( 212)			return value;
            		}
HXLINE( 214)		this->font = value;
HXLINE( 215)		this->_hx___dirty = true;
...
::Array< int > TextLayout_obj::get_glyphs(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_222_get_glyphs)
HXLINE( 223)		::Array< int > glyphs = ::Array_obj< int >::__new(0);
HXLINE( 225)		{
HXLINE( 225)			int _g = 0;
HXDLIN( 225)			::Array< ::Dynamic> _g1 = this->get_positions();
HXDLIN( 225)			while((_g < _g1->length)){
HXLINE( 225)				 ::openfl::_internal::text::GlyphPosition position = _g1->__get(_g).StaticCast<  ::openfl::_internal::text::GlyphPosition >();
HXDLIN( 225)				_g = (_g + 1);
HXLINE( 227)				glyphs->push(position->glyph);
            			}
            		}
HXLINE( 230)		return glyphs;
            	}
...
::String TextLayout_obj::get_language(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_235_get_language)
HXDLIN( 235)		return this->_hx___language;
            	}
...
::String TextLayout_obj::set_language(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_239_set_language)
HXLINE( 240)		if ((value == this->_hx___language)) {
HXLINE( 240)			return value;
            		}
HXLINE( 242)		this->_hx___language = value;
HXLINE( 243)		this->_hx___dirty = true;
...
::String TextLayout_obj::get_script(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_250_get_script)
HXDLIN( 250)		return this->_hx___script;
            	}
...
::String TextLayout_obj::set_script(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_254_set_script)
HXLINE( 255)		if ((value == this->_hx___script)) {
HXLINE( 255)			return value;
            		}
HXLINE( 257)		this->_hx___script = value;
HXLINE( 258)		this->_hx___dirty = true;
...
int TextLayout_obj::set_size(int value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_264_set_size)
HXLINE( 265)		if ((value == this->size)) {
HXLINE( 265)			return value;
            		}
HXLINE( 267)		this->size = value;
HXLINE( 268)		this->_hx___dirty = true;
...
::String TextLayout_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_273_set_text)
HXLINE( 274)		if ((value == this->text)) {
HXLINE( 274)			return value;
            		}
HXLINE( 276)		this->text = value;
