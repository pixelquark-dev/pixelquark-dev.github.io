...
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_297_reverse,"openfl._internal.text._TextLayout.TextDirection_Impl_","reverse",0xf3fb0bfd,"openfl._internal.text._TextLayout.TextDirection_Impl_.reverse","openfl/_internal/text/TextLayout.hx",297,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_302_toString,"openfl._internal.text._TextLayout.TextDirection_Impl_","toString",0x3e687d71,"openfl._internal.text._TextLayout.TextDirection_Impl_.toString","openfl/_internal/text/TextLayout.hx",302,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_315_toHBDirection,"openfl._internal.text._TextLayout.TextDirection_Impl_","toHBDirection",0x7ad2a365,"openfl._internal.text._TextLayout.TextDirection_Impl_.toHBDirection","openfl/_internal/text/TextLayout.hx",315,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_328_get_backward,"openfl._internal.text._TextLayout.TextDirection_Impl_","get_backward",0x2c628331,"openfl._internal.text._TextLayout.TextDirection_Impl_.get_backward","openfl/_internal/text/TextLayout.hx",328,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_333_get_forward,"openfl._internal.text._TextLayout.TextDirection_Impl_","get_forward",0xda561e37,"openfl._internal.text._TextLayout.TextDirection_Impl_.get_forward","openfl/_internal/text/TextLayout.hx",333,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_338_get_horizontal,"openfl._internal.text._TextLayout.TextDirection_Impl_","get_horizontal",0x3e4093b2,"openfl._internal.text._TextLayout.TextDirection_Impl_.get_horizontal","openfl/_internal/text/TextLayout.hx",338,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_343_get_vertical,"openfl._internal.text._TextLayout.TextDirection_Impl_","get_vertical",0x6f5f63c4,"openfl._internal.text._TextLayout.TextDirection_Impl_.get_vertical","openfl/_internal/text/TextLayout.hx",343,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_285_boot,"openfl._internal.text._TextLayout.TextDirection_Impl_","boot",0xe4242a77,"openfl._internal.text._TextLayout.TextDirection_Impl_.boot","openfl/_internal/text/TextLayout.hx",285,0x21621597)
...
void TextDirection_Impl__obj::reverse(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_297_reverse)
...
::String TextDirection_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_302_toString)
HXDLIN( 302)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 304)				return HX_("leftToRight",1a,97,7b,b5);
            			}
            			break;
            			case (int)5: {
HXLINE( 305)				return HX_("rightToLeft",1e,40,ee,e6);
            			}
            			break;
            			case (int)6: {
HXLINE( 306)				return HX_("topToBottom",7b,ce,19,75);
            			}
            			break;
            			case (int)7: {
HXLINE( 307)				return HX_("bottomToTop",ef,ac,aa,79);
            			}
            			break;
            			default:{
HXLINE( 308)				return HX_("",00,00,00,00);
            			}
            		}
...
int TextDirection_Impl__obj::toHBDirection(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_315_toHBDirection)
HXDLIN( 315)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 317)				return 4;
            			}
            			break;
...
bool TextDirection_Impl__obj::get_backward(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_328_get_backward)
HXDLIN( 328)		return ((this1 & -3) == 5);
            	}
...
bool TextDirection_Impl__obj::get_forward(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_333_get_forward)
HXDLIN( 333)		return ((this1 & -3) == 4);
            	}
...
bool TextDirection_Impl__obj::get_horizontal(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_338_get_horizontal)
HXDLIN( 338)		return ((this1 & -2) == 4);
            	}
...
bool TextDirection_Impl__obj::get_vertical(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_343_get_vertical)
HXDLIN( 343)		return ((this1 & -2) == 6);
            	}
