...
HXLINE(  68)						graphics->beginGradientFill(fillType,colors,alphas,ratios,matrix1,spreadMethod,interpolationMethod,focalPointRatio);
            					}
            					break;
            					case (int)3: {
HXLINE(  71)						Float anchorY = command->_hx_getFloat(3);
HXDLIN(  71)						Float anchorX = command->_hx_getFloat(2);
HXDLIN(  71)						Float controlY = command->_hx_getFloat(1);
HXDLIN(  71)						Float controlX = command->_hx_getFloat(0);
HXLINE(  72)						graphics->curveTo(controlX,controlY,anchorX,anchorY);
            					}
            					break;
            					case (int)4: {
...
HXLINE(  78)						if (hx::IsNotNull( thickness )) {
HXLINE(  80)							graphics->lineStyle(thickness,color1,alpha1,pixelHinting,scaleMode,caps,joints,miterLimit);
            						}
            						else {
...
HXLINE(  89)						graphics->lineTo(x,y);
            					}
            					break;
            					case (int)7: {
HXLINE(  91)						Float y1 = command->_hx_getFloat(1);
HXDLIN(  91)						Float x1 = command->_hx_getFloat(0);
...
HXLINE(  96)		this->commands = null();
HXLINE(  97)		this->rendered =  ::openfl::display::Shape_obj::__alloc( HX_CTX );
HXLINE(  98)		 ::openfl::display::Graphics _hx_tmp = this->rendered->get_graphics();
HXDLIN(  98)		_hx_tmp->copyFrom(shape->get_graphics());
HXLINE( 100)		return shape;
            	}
