...
HXLINE(  26)		::openfl::display::SimpleButton_obj::_hx___initSWF = swf;
HXLINE(  27)		::openfl::display::SimpleButton_obj::_hx___initSymbol = hx::ObjectPtr<OBJ_>(this);
HXLINE(  36)		if (hx::IsNotNull( this->className )) {
HXLINE(  38)			hx::Class symbolType = ::Type_obj::resolveClass(this->className);
HXLINE(  40)			if (hx::IsNotNull( symbolType )) {
HXLINE(  42)				simpleButton = ( ( ::openfl::display::SimpleButton)(::Type_obj::createInstance(symbolType,::cpp::VirtualArray_obj::__new(0))) );
            			}
            		}
HXLINE(  50)		if (hx::IsNull( simpleButton )) {
HXLINE(  52)			simpleButton =  ::openfl::display::SimpleButton_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}
