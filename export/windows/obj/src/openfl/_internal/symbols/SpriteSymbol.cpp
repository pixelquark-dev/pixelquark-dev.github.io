...
HXLINE(  40)		hx::Class symbolType = null();
HXLINE(  42)		if (hx::IsNotNull( this->className )) {
HXLINE(  44)			symbolType = ::Type_obj::resolveClass(this->className);
HXLINE(  46)			bool _hx_tmp = hx::IsNull( symbolType );
            		}
...
HXLINE(  61)			symbolType = ::Type_obj::resolveClass(this->baseClassName);
HXLINE(  63)			bool _hx_tmp2 = hx::IsNull( symbolType );
            		}
HXLINE(  69)		 ::openfl::display::MovieClip movieClip = null();
HXLINE(  71)		if (hx::IsNotNull( symbolType )) {
HXLINE(  73)			movieClip = ( ( ::openfl::display::MovieClip)(::Type_obj::createInstance(symbolType,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		else {
HXLINE(  80)			movieClip =  ::openfl::display::MovieClip_obj::__alloc( HX_CTX );
            		}
HXLINE(  84)		movieClip->set_scale9Grid(this->scale9Grid);
HXLINE(  86)		return movieClip;
            	}
