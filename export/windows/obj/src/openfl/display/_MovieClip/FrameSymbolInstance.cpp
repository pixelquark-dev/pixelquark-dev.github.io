...
HX_DEFINE_STACK_FRAME(_hx_pos_e7c49b2409073623_1228_new,"openfl.display._MovieClip.FrameSymbolInstance","new",0xd335e789,"openfl.display._MovieClip.FrameSymbolInstance.new","openfl/display/MovieClip.hx",1228,0x2b84738a)
namespace openfl{
namespace display{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_e7c49b2409073623_1228_new)
HXLINE(1229)		this->initFrame = initFrame;
HXLINE(1230)		this->initFrameObjectID = initFrameObjectID;
HXLINE(1231)		this->characterID = characterID;
HXLINE(1232)		this->depth = depth;
HXLINE(1233)		this->displayObject = displayObject;
HXLINE(1234)		this->clipDepth = clipDepth;
            	}
