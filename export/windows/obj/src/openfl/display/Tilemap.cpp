...
HXLINE( 120)		this->_hx___tileset = tileset;
HXLINE( 121)		this->smoothing = smoothing;
HXLINE( 123)		this->tileAlphaEnabled = true;
HXLINE( 124)		this->tileBlendModeEnabled = true;
HXLINE( 125)		this->tileColorTransformEnabled = true;
HXLINE( 127)		this->_hx___group =  ::openfl::display::TileContainer_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null());
HXLINE( 128)		this->_hx___group->set_tileset(tileset);
HXLINE( 130)		this->_hx___width = width;
HXLINE( 131)		this->_hx___height = height;
HXLINE( 132)		this->_hx___type = ::openfl::_internal::renderer::DisplayObjectType_obj::TILEMAP_dyn();
            	}
...
static hx::StorageInfo Tilemap_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*  ::openfl::_internal::renderer::context3D::Context3DBuffer */ ,(int)offsetof(Tilemap_obj,_hx___buffer),HX_("__buffer",20,28,c4,78)},
