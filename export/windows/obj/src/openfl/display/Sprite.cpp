...
HXLINE( 265)				_hx_tmp5 = hx::IsNotNull( this->_hx___graphics );
            			}
            			else {
HXLINE( 265)				_hx_tmp5 = false;
            			}
HXDLIN( 265)			if (_hx_tmp5) {
HXLINE( 265)				 ::openfl::display::Graphics _hx_tmp6 = this->_hx___graphics;
HXDLIN( 265)				_hx_tmp4 = _hx_tmp6->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            			}
            			else {
HXLINE( 265)				_hx_tmp4 = false;
            			}
HXDLIN( 265)			if (_hx_tmp4) {
HXLINE( 267)				bool _hx_tmp7;
HXDLIN( 267)				if (hx::IsNotNull( stack )) {
HXLINE( 267)					if (!(!(interactiveOnly))) {
HXLINE( 267)						_hx_tmp7 = this->mouseEnabled;
            					}
            					else {
HXLINE( 267)						_hx_tmp7 = true;
            					}
            				}
            				else {
HXLINE( 267)					_hx_tmp7 = false;
            				}
HXDLIN( 267)				if (_hx_tmp7) {
