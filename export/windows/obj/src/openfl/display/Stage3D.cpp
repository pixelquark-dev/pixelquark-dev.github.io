...
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_443___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",443,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_450___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",450,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_458___lostContext,"openfl.display.Stage3D","__lostContext",0x951652e2,"openfl.display.Stage3D.__lostContext","openfl/display/Stage3D.hx",458,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_470___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",470,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_494___restoreContext,"openfl.display.Stage3D","__restoreContext",0xa732262a,"openfl.display.Stage3D.__restoreContext","openfl/display/Stage3D.hx",494,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_501_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",501,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_505_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",505,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_516_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",516,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_520_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",520,0x37141b9b)
namespace openfl{
namespace display{
...
HXDLIN( 371)		if (hx::IsNotNull( this->_hx___stage->context3D )) {
HXLINE( 376)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,this->_hx___stage,this->_hx___stage->context3D->_hx___contextState,hx::ObjectPtr<OBJ_>(this));
HXLINE( 378)			this->_hx___dispatchCreate();
            		}
            		else {
HXLINE( 438)			this->_hx___dispatchError();
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_443___dispatchError)
HXLINE( 444)		this->_hx___contextRequested = false;
HXLINE( 445)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_450___dispatchCreate)
HXDLIN( 450)		if (this->_hx___contextRequested) {
HXLINE( 452)			this->_hx___contextRequested = false;
HXLINE( 453)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___lostContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_458___lostContext)
HXLINE( 459)		this->_hx___contextLost = true;
HXLINE( 461)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 463)			this->context3D->_hx___dispose();
HXLINE( 464)			this->_hx___contextRequested = true;
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_470___resize)
HXDLIN( 470)		bool _hx_tmp;
HXDLIN( 470)		if ((width == this->_hx___width)) {
HXDLIN( 470)			_hx_tmp = (height != this->_hx___height);
            		}
            		else {
HXDLIN( 470)			_hx_tmp = true;
            		}
HXDLIN( 470)		if (_hx_tmp) {
HXLINE( 480)			 ::openfl::geom::Matrix3D _hx_tmp1 = this->_hx___projectionTransform;
HXDLIN( 480)			int length = null();
HXDLIN( 480)			bool fixed = null();
HXLINE( 481)			int _hx_tmp2;
HXDLIN( 481)			if ((width > 0)) {
HXLINE( 481)				_hx_tmp2 = width;
            			}
            			else {
HXLINE( 481)				_hx_tmp2 = 1;
            			}
HXDLIN( 481)			int _hx_tmp3;
HXDLIN( 481)			if ((height > 0)) {
HXLINE( 481)				_hx_tmp3 = height;
            			}
            			else {
HXLINE( 481)				_hx_tmp3 = 1;
            			}
HXLINE( 480)			_hx_tmp1->copyRawDataFrom( ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,::Array_obj< Float >::__new(16)->init(0,(((Float)2.0) / ( (Float)(_hx_tmp2) )))->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,(((Float)-2.0) / ( (Float)(_hx_tmp3) )))->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)-0.001))->init(11,((Float)0.0))->init(12,((Float)-1.0))->init(13,((Float)1.0))->init(14,((Float)0.0))->init(15,((Float)1.0)),true),null(),null());
HXLINE( 484)			this->_hx___renderTransform->identity();
HXLINE( 485)			this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,( (Float)(0) ));
HXLINE( 486)			this->_hx___renderTransform->append(this->_hx___projectionTransform);
HXLINE( 488)			this->_hx___width = width;
HXLINE( 489)			this->_hx___height = height;
            		}
            	}
...
void Stage3D_obj::_hx___restoreContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_494___restoreContext)
HXLINE( 495)		this->_hx___contextLost = false;
HXLINE( 496)		this->_hx___createContext();
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_501_get_x)
HXDLIN( 501)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_505_set_x)
HXLINE( 506)		if ((this->_hx___x == value)) {
HXLINE( 506)			return value;
            		}
HXLINE( 507)		this->_hx___x = value;
HXLINE( 508)		this->_hx___renderTransform->identity();
HXLINE( 509)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,( (Float)(0) ));
HXLINE( 510)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_516_get_y)
HXDLIN( 516)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_520_set_y)
HXLINE( 521)		if ((this->_hx___y == value)) {
HXLINE( 521)			return value;
            		}
HXLINE( 522)		this->_hx___y = value;
HXLINE( 523)		this->_hx___renderTransform->identity();
HXLINE( 524)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,( (Float)(0) ));
HXLINE( 525)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
