...
HXLINE( 286)			Float scaleX = ((Float)0.0);
HXLINE( 287)			Float scaleY = ((Float)0.0);
HXLINE( 289)			if ((b == 0)) {
HXLINE( 291)				scaleX = a;
            			}
            			else {
HXLINE( 295)				scaleX = ::Math_obj::sqrt(((a * a) + (b * b)));
            			}
HXLINE( 298)			if ((c == 0)) {
HXLINE( 300)				scaleY = d;
            			}
            			else {
HXLINE( 304)				scaleY = ::Math_obj::sqrt(((c * c) + (d * d)));
            			}
HXLINE( 307)			this->_hx___displayObject->_hx___scaleX = scaleX;
HXLINE( 308)			this->_hx___displayObject->_hx___scaleY = scaleY;
HXLINE( 310)			Float rotation = (((( (Float)(180) ) / ::Math_obj::PI) * ::Math_obj::atan2(d,c)) - ( (Float)(90) ));
HXLINE( 312)			if ((rotation != this->_hx___displayObject->_hx___rotation)) {
HXLINE( 314)				this->_hx___displayObject->_hx___rotation = rotation;
HXLINE( 315)				Float radians = (rotation * (::Math_obj::PI / ( (Float)(180) )));
HXLINE( 316)				this->_hx___displayObject->_hx___rotationSine = ::Math_obj::sin(radians);
HXLINE( 317)				this->_hx___displayObject->_hx___rotationCosine = ::Math_obj::cos(radians);
            			}
HXLINE( 320)			this->_hx___displayObject->_hx___transform->a = a;
HXLINE( 321)			this->_hx___displayObject->_hx___transform->b = b;
HXLINE( 322)			this->_hx___displayObject->_hx___transform->c = c;
HXLINE( 323)			this->_hx___displayObject->_hx___transform->d = d;
HXLINE( 324)			this->_hx___displayObject->_hx___transform->tx = tx;
HXLINE( 325)			this->_hx___displayObject->_hx___transform->ty = ty;
HXLINE( 327)			this->_hx___displayObject->_hx___setTransformDirty();
            		}
            	}
