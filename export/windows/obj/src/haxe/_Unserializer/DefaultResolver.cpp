...
HX_LOCAL_STACK_FRAME(_hx_pos_f781113f3a571312_474_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",474,0x00b9ec83)
HX_LOCAL_STACK_FRAME(_hx_pos_f781113f3a571312_477_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",477,0x00b9ec83)
namespace haxe{
...
hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_f781113f3a571312_474_resolveClass)
HXDLIN( 474)		return ::Type_obj::resolveClass(name);
            	}
...
hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_f781113f3a571312_477_resolveEnum)
HXDLIN( 477)		return ::Type_obj::resolveEnum(name);
            	}
