...
HXLINE(  89)		if ((maxbits > 32)) {
HXLINE(  90)			HX_STACK_DO_THROW(HX_("Invalid huffman",e4,e4,8f,a6));
            		}
HXLINE(  91)		{
HXLINE(  91)			int _g = 0;
HXDLIN(  91)			int _g1 = maxbits;
HXDLIN(  91)			while((_g < _g1)){
HXLINE(  91)				_g = (_g + 1);
HXDLIN(  91)				int i = (_g - 1);
HXLINE(  92)				counts->push(0);
HXLINE(  93)				tmp->push(0);
            			}
            		}
HXLINE(  95)		{
HXLINE(  95)			int _g2 = 0;
HXDLIN(  95)			int _g3 = nlengths;
HXDLIN(  95)			while((_g2 < _g3)){
HXLINE(  95)				_g2 = (_g2 + 1);
HXDLIN(  95)				int i1 = (_g2 - 1);
HXLINE(  96)				int p = lengths->__get((i1 + pos));
HXLINE(  97)				if ((p >= maxbits)) {
HXLINE(  98)					HX_STACK_DO_THROW(HX_("Invalid huffman",e4,e4,8f,a6));
            				}
HXLINE(  99)				counts[p]++;
            			}
            		}
HXLINE( 101)		int code = 0;
HXLINE( 102)		{
HXLINE( 102)			int _g4 = 1;
HXDLIN( 102)			int _g5 = (maxbits - 1);
HXDLIN( 102)			while((_g4 < _g5)){
HXLINE( 102)				_g4 = (_g4 + 1);
HXDLIN( 102)				int i2 = (_g4 - 1);
HXLINE( 103)				code = ((code + counts->__get(i2)) << 1);
HXLINE( 104)				tmp[i2] = code;
            			}
            		}
HXLINE( 106)		 ::haxe::ds::IntMap bits =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 107)		{
HXLINE( 107)			int _g6 = 0;
HXDLIN( 107)			int _g7 = nlengths;
HXDLIN( 107)			while((_g6 < _g7)){
HXLINE( 107)				_g6 = (_g6 + 1);
HXDLIN( 107)				int i3 = (_g6 - 1);
HXLINE( 108)				int l = lengths->__get((i3 + pos));
HXLINE( 109)				if ((l != 0)) {
HXLINE( 110)					int n = tmp->__get((l - 1));
HXLINE( 111)					tmp[(l - 1)] = (n + 1);
HXLINE( 112)					bits->set(((n << 5) | l),i3);
            				}
            			}
            		}
HXLINE( 115)		 ::haxe::zip::Huffman _hx_tmp = this->treeMake(bits,maxbits,0,1);
HXDLIN( 115)		return this->treeCompress(::haxe::zip::Huffman_obj::NeedBit(_hx_tmp,this->treeMake(bits,maxbits,1,1)));
            	}
